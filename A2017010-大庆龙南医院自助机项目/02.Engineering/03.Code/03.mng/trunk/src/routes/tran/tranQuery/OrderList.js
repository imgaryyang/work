...
class OrderList extends Component {
  ...
  render() {
    ...
    const columns = [
      { title: '编号', dataIndex: 'orderNo', key: 'orderNo', width: 80 },
      { title: '时间', dataIndex: 'createTime', key: 'createTime', width: 80},
      ...
      { title: '患者编号', dataIndex: 'patientNo', key: 'patientNo', width: 50 },
      ...
      { title: '状态',  dataIndex: 'status',  key: 'status', width: 60,render: (value) => {
      ...
      { title: '发生金额', dataIndex: 'realAmt', key: 'realAmt', width: 60, render: value => value.formatMoney() },
      { title: '操作',
        key: 'action',
        render: (text, record) => (
          <span>
