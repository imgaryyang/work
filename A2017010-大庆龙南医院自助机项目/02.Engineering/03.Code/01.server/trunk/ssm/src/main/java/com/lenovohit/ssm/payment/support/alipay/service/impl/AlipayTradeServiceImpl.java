package com.lenovohit.ssm.payment.support.alipay.service.impl;
...
import com.lenovohit.ssm.payment.support.alipay.config.Constants;
...
import com.lenovohit.ssm.payment.support.alipay.model.builder.AlipayTradePayRequestBuilder;
...
import com.lenovohit.ssm.payment.support.alipay.model.response.AlipayPaySyncResponse;
import com.lenovohit.ssm.payment.support.alipay.model.result.AlipayF2FDownloadResult;
import com.lenovohit.ssm.payment.support.alipay.model.result.AlipayF2FPayResult;
import com.lenovohit.ssm.payment.support.alipay.model.result.AlipayF2FPaySyncResult;
...
public class AlipayTradeServiceImpl extends AbsAlipayTradeService {
	...
	public AlipayF2FRefundQueryResult tradeRefundQueryResult(AlipayTradeRefundQueryRequestBuilder builder) {
        ...
        AlipayF2FRefundQueryResult result = new AlipayF2FRefundQueryResult(response);
	...
	protected boolean queryRefundSuccess(AlipayTradeFastpayRefundQueryResponse response) {
		return response != null && Constants.SUCCESS.equals(response.getCode()) && (null != response.getTotalAmount());
	}
