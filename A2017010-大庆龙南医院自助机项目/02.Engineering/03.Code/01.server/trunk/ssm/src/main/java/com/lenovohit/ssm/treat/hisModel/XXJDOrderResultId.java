...
public class XXJDOrderResultId implements Model{
	 ...
	 */
	public int hashCode() {
		return new HashCodeBuilder().append(this.getOrderno()).append(this.getJyname()).append(this.getItemCode()).toHashCode();
	}
	...
	public boolean _newObejct() {
		return null == this.getOrderno() && null == this.getJyname() && null == this.getItemCode();
	}
}
