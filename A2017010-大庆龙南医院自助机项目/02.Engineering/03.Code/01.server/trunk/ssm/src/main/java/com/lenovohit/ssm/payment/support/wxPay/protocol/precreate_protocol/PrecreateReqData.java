package com.lenovohit.ssm.payment.support.wxPay.protocol.precreate_protocol;
...
public class PrecreateReqData {
	...
	public PrecreateReqData(String body, String attach, String outTradeNo, int totalFee, String deviceInfo,
        ...
        //异步接收微信支付结果通知的回调地址
        setNotify_url(Configure.getLocalDomain() + Configure.getPayCallbackUrl());
