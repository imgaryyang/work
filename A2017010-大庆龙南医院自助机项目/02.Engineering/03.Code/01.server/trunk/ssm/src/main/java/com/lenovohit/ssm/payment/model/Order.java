...
public class Order extends BaseIdModel{
	...
	public static final String ORDER_TYPE_AFTER = "OB";//补录
	...
	private String bizType;//业务类型  '00': '门诊预存','01': '预约','02': '挂号','03': '门诊缴费','04': '住院预缴','05': '办理就诊卡', '06'： '社保建档'},
	private String bizNo;//业务订单号
	...
	private String optStatus;//操作状态 0-正常 E-异常 T-同步 A-补录	
