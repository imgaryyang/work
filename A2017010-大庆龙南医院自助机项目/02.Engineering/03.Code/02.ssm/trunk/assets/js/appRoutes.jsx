...
import PrescriptionHistory from './pages/prescription/PrescriptionHistory.jsx';
import TmsAssayRecords from './pages/assay/TmsAssayRecords.jsx';
import AssayRecords from './pages/assay/AssayRecords.jsx';
import PacsRecords from './pages/pacs/PacsRecords.jsx';
import QueryMain from './pages/miQuery/QueryMain.jsx';
...
import PetroleumMain from './pages/petroleum/ProfileMain.jsx';
import OperatorList from './pages/operator/OperatorList.jsx';
import OperationMain from './pages/opt/OperationMain.jsx';
    ...
    var result =   (
	  <Router onUpdate={() => window.scrollTo(0, 0)} history={history}>
	    <Route component={Framework}>
	      ...
	      <Route path="/card/oil/:type" component={ PetroleumMain }/>
	      <Route path="/card/miQuery" component={ QueryMain }/>
	      ...
	      <Route path="/clinic/prescriptionHistory" component={ PrescriptionHistory }/>
	      ...
	      <Route path="/pacs/pacsRecords" component={PacsRecords }/>
	      ...
	      <Route path="/opt/issueOptCard" component={ OperatorList }/>
	      ...
	      <Route path="/opt/main" component={ OperationMain }/>
