...
const PRINTER_KEY = "A1B2C3D4E5F6";
var PRINTER;
...
function PrintCard(name,cardNo,type){
	...
	//动态健康号字体参数
	PRINTER.CardNoFontSize = 60;//字体大小
	PRINTER.CardNoFontWeight = 1000;//粗细  400为正常  800为加粗
	PRINTER.CardNoFontName = "微软雅黑";

	PRINTER.CardNo = type+':'+cardNo;//打印的就诊卡号
	//PRINTER.CardNo_X = 780-(cardNo.length-10)*21;
	PRINTER.CardNo_X = 520;
	PRINTER.CardNo_Y = 558;
...
function ReadCardNo() {
	try{
		var data = ReadCard(1,4);//省市编码：第1扇区第1块(块编码为4)
		var cardNo = data.substr(0,16) 
		return cardNo;
	}catch(e){
