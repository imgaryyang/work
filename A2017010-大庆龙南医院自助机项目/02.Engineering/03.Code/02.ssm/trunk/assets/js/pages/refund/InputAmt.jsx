...
class InputAmt extends TimerPage {
  ...
  constructor(props) {
    ...
    this.getLimit = this.bind(this.getLimit,this);
    this.renderInfoConfirm = this.bind(this.renderInfoConfirm,this);
    this.frozen = this.bind(this.frozen,this);
        ...
        <Row  style = {{margin: '10rem 0 10rem 0'}}>
          <Col span = {12} style = {{paddingRight: '1rem'}} >
            <Card  style = {cardStyle} >
              <span className = 're_amt_balance' >就诊卡账户余额&nbsp;<font>{(patient.balance||0).formatMoney()}</font>&nbsp;元</span>
