...
class Page extends TimerPage {
	constructor (props) {
		super(props);
		this.startIdCard = this.bind(this.startIdCard,this);
		this.onIdCardReaded = this.bind(this.onIdCardReaded,this);
		this.buildProfileById = this.bind(this.buildProfileById,this);
		this.loadPatientInfo = this.bind(this.loadPatientInfo,this);
		this.afterIdCardRead = this.bind(this.afterIdCardRead,this);
	...
	onIdCardReaded(idCardInfo){
		if(idCardInfo.stateCode != 144){
			var msg = idCardInfo.msg || '读取身份证信息失败';
			baseUtil.error(msg);
			return;
		}
	...
	buildProfileById(idCardInfo){
	  const {Name, Sex, Nation,Born,IdCardUID} = idCardInfo;
	  const {Address,IDCardNo,GrantDept,effectiveDate} = idCardInfo;
	  
	// var cardInfo = {"stateCode":144,"Name":"黄志军","Sex":"男","Nation":"汉","Born":"19840816",
	//  "Address":"江西省新余市分宜县高岚乡岚胜路55号","IDCardNo":"360521198408168016","GrantDept":"分宜县公安局","UserLifeBegin":"20110319","UserLifeEnd":"20310319",
	//  "IdCardUID":"414CBB0364F27F5D","puiRecvIDLen":8};
	  
	  var gender = '3';
	  if('男' == Sex)gender = '1';
	  if('女' == Sex)gender = '2';
	  const profile={
	    name:Name,gender:gender,idNo:IDCardNo,birthday:Born,
	    address:Address,unitCode:'0000',medicalCardNo:'',opentype:'1',idCardUid :IdCardUID,
