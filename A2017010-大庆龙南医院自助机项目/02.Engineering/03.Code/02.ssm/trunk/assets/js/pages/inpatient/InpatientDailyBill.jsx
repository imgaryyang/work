...
class InpatientDailyBill extends TimerModule {
  
  constructor(props) {
    super(props);
    this.loadBills = this.bind(this.loadBills,this);
    this.renderItems      = this.bind(this.renderItems,this);
    this.openCalendarWin = this.bind(this.openCalendarWin,this);
    this.onSelectDate   = this.bind(this.onSelectDate,this);
    this.preDay           = this.bind(this.preDay,this);
    this.nextDay          = this.bind(this.nextDay,this);
    ...
    this.loadInpatientInfo = this.bind(this.loadInpatientInfo,this);
    this. state = {
  ...
  render() {
    ...
    return (
     <NavContainer title='住院日清单' onBack={this.onBack} onHome={this.onHome} >
        ...
        <Row>
          <Col span = {14} className = 'list_title' >收费项目/（规格）</Col>
          <Col span = {2} className = 'list_title list_amt' >单价</Col>
          <Col span = {2} className = 'list_title list_amt' >数量</Col>
          <Col span = {3} className = 'list_title list_amt' >金额</Col>
          <Col span = {3} className = 'list_title list_amt' >缴费状态</Col>
        </Row>
      ...
      return (
    		  <div key = {'_daily_bill_items_' + idx} className = 'idb_row' >
	              <Row type="flex" align="middle" >
	                <Col span = {14} className = 'list_item' >{itemName}{itemSepc}</Col>
	                ...
	                <Col span = {3} className = 'list_title list_amt' >
	                  {state[paymentStatus]||""}
	                </Col>
	              </Row>
	            </div>
