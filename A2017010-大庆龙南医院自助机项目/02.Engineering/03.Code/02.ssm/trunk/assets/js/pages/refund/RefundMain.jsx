...
class Page extends TimerModule {
	constructor (props) {
		super(props);
		this.go = this.bind(this.go,this);
		this.afterActSelect = this.bind(this.afterActSelect,this);
		this.afterVerfied = this.bind(this.afterVerfied,this);
		this.cancelVerfied = this.bind(this.cancelVerfied,this);
		
		this.refundBank = this.bind(this.refundBank,this);
		this.loadCreditAmt = this.bind(this.loadCreditAmt,this);
		this.selectRecord = this.bind(this.selectRecord,this);
		this.cancelAmt = this.bind(this.cancelAmt,this);
		this.cancelRecord = this.bind(this.cancelRecord,this);
		this.afterRefund = this.bind(this.afterRefund,this);
		this.state = {
		  step:1,
		  creditAmt:0,
		  account:{},
