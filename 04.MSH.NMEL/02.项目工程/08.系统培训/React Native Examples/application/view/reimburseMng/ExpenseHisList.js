...
var FIND_URL = 'expense/findByLeader';
var FIND_EMP_URL = 'expense/findEmp';
var ExpenseHisList = React.createClass({
	...
	*/
	...
	renderItem: function(item, sectionID, rowID, highlightRow) {
		...
		return (
			<View>
				{topLine}
				<TouchableOpacity style={[styles.item, Global.styles.CENTER]} onPress={()=>{this.showDetail(item.id)}}>
					<View style={{flex: 1, flexDirection: 'column'}}>
						...
						<Text style={{flex: 1, marginLeft: 20, fontSize: 13, marginTop: 3, color: Global.colors.IOS_GRAY_FONT}}>事由：{item.memo1}</Text>
					</View>
