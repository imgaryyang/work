		...
		return (
			<View style = {Global._styles.CONTAINER} >
				...
				<ScrollView style = {styles.scrollView} keyboardShouldPersistTaps={true}>
					...
					<TouchableOpacity onPress={() => this.goNextStep(2) } style={{padding:10}}>
					...
					<View style={Global._styles.FULL_SEP_LINE} />
					<TouchableOpacity onPress={() => this.goNextStep(3) } style={{padding:10}}>
						<View style={{flex:1, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between'}}>
					...
					<View style={Global._styles.FULL_SEP_LINE} />
					<TouchableOpacity onPress={() => this.goNextStep(4) } style={{padding:10}}>
						<View style={{flex:1, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between'}}>
