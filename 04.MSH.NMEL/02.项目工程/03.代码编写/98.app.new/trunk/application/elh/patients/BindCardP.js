...
const SAVE_CARD_URL = 'elh/medicalCard/my/createhoscard/';

class BindCardP extends Component {

    static displayName = 'BindCardP';
    static description = '添加就诊卡信息';
            ...
            <View style = {[Global._styles.CONTAINER, { backgroundColor: '#ffffff' }]} >
                ...
                <ScrollView style = {styles.scrollView} keyboardShouldPersistTaps={true}>
                    <Form ref = {(c) => that.form = c} showLabel = {this.state.showLabel} labelPosition = {this.state.labelPosition} 
                        ...
                        <Form.Picker name = "selorgId" label = "支持医院" placeholder = "请选择医院" help = "会陆续增加更多支持医院，敬请期待" required = {true} dataSource = {this.state.beSelectOrg} />
                        <Form.TextInput name = "cardholder" label = "持卡人姓名" required = {true} minLength = {2} maxLength = {20} editable = {false} showClearIcon={false}/>
                        <Form.TextInput name = "cardNo" label = "就诊卡号" placeholder = "请输入卡号" required = {true} minLength = {6} maxLength = {20} dataType = "number" help = "请输入就诊卡号" />
