      ...
      <View style = {[Global._styles.CONTAINER]} >
        ...
        <ScrollView style = {styles.scrollView} keyboardShouldPersistTaps = {true} >
          ...
          <Form ref = {(c) => this.form = c} onChange = {this.onChange} value = {this.state.value} showLabel = {false}>
            <Form.TextInput name = "PayPassword"  label="支付密码" placeholder = "请输入您的支付密码" password = {true} required = {true}  maxLength = {6} minLength = {6}  icon = "md-lock" />
            <Form.TextInput name = "PayPassword2" label="再次输入支付密码"  placeholder = "请再次输入您的支付密码" password = {true}  maxLength = {6} minLength = {6}  required = {true} icon = "md-lock" />
          </Form>
