...
class Profile extends Component {
  ...
  getList() {
    return [
      ...
      {
        textLeft: '性别',
        textRight: this.state.userInfo.gender == null ? '未填写' : (this.state.userInfo.gender == 1 ? '男' : '女'),
      },
    ...
    return (
      <View style={Global._styles.CONTAINER}>
        ...
        <ScrollView>
          ...
          <TouchableOpacity style={Global._styles.CENTER} onPress={() => {
            this.push('我的头像', Portrait, true);
          }}>
            <View style={[styles.listItem2, Global._styles.CENTER]}>
              ...
              <EasyIcon iconLib='fa' name='angle-right' size={18} color={Global._colors.IOS_ARROW}
                        style={[{width: 40}]}/>
            </View>
          </TouchableOpacity>
          <View style={Global._styles.FULL_SEP_LINE}/>
          ...
          {this._renderList()}
          <View style={Global._styles.PLACEHOLDER20}/>
          <Button text="编辑" onPress={() => {
            this.push('个人资料修改', EditProfile, true);
          }} style={{marginLeft: 10, marginRight: 10}} theme={Button.THEME.BLUE}/>
          <View style={Global._styles.PLACEHOLDER20}/>
