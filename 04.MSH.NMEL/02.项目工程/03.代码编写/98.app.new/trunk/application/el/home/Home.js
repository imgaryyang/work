...
class Home extends Component {
  ...
  static navigationOptions = () => ({
    headerLeft: (
      <Button
        ...
        stretch={false}
        clear
        style={Global._styles.NAV_BAR.BUTTON}
      >
        <Image
          resizeMode="cover"
  ...
  async fetchTest() {
    try {
      const res = await this.request('http://182.48.115.37:8081/iMovie/yppt/getWillFilms.do');
  ...
  render() {
    ...
    return (
      <View style={Global._styles.CONTAINER}>
        ...
        <ImageBackground
          resizeMode="cover"
          source={require('../../res/images/base/home-top-bg.jpg')}
          style={[styles.topImg, Global._styles.CENTER]}
        >
