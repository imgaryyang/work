...
@Entity
@Table(name = "ELS_STUB_BATCHINFO")
public class StubBatchinfo extends BaseIdModel {
...
//	@Column(name = "ID_NO", length = 18)
	...
	public StubBatchinfo(){
		
	}
	public StubBatchinfo(StubPreview a) {
		this.perId = a.getPerId();
		this.batchId = a.getBatchId();
		this.batchNo = a.getBatchNo();
		this.month = a.getMonth();
		this.setIdNo(a.getIdNo());
		this.name = a.getName();
		this.note = a.getNote();
		this.templateId = a.getTemplateId();
		this.template = a.getTemplate();
		this.item1 = a.getItem1();
		this.item2 = a.getItem2();
		this.item3 = a.getItem3();
		this.item4 = a.getItem4();
		this.item5 = a.getItem5();
		this.item6 = a.getItem6();
		this.item7 = a.getItem7();
		this.item8 = a.getItem8();
		this.item9 = a.getItem9();
		this.item10 = a.getItem10();
		this.item11 = a.getItem11();
		this.item12 = a.getItem12();
		this.item13 = a.getItem13();
		this.item14 = a.getItem14();
		this.item15 = a.getItem15();
		this.item16 = a.getItem16();
		this.item17 = a.getItem17();
		this.item18 = a.getItem18();
		this.item19 = a.getItem19();
		this.item20 = a.getItem20();
		this.item21 = a.getItem21();
		this.item22 = a.getItem22();
		this.item23 = a.getItem23();
		this.item24 = a.getItem24();
		this.item25 = a.getItem25();
		this.item26 = a.getItem26();
		this.item27 = a.getItem27();
		this.item28 = a.getItem28();
		this.item29 = a.getItem29();
		this.item30 = a.getItem30();
	}
