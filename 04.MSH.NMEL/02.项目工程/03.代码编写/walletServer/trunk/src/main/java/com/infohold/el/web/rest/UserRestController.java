...
import com.infohold.el.base.model.AppUser;
...
public class UserRestController extends BaseRestController {
	...
	public Result forRegister(@RequestBody String data) {
		...
		String group = (null==dataMap.get("group"))?null:dataMap.get("group").toString();
		Object idCardNoObj = dataMap.get("idCardNo");
		String idCardNo = (null==idCardNoObj)?null:idCardNoObj.toString();
...
//		this.userManager.executeSql(upSql, payPasswdHash,_user.getId());
	 ...
	 * 用户列表查询
	 */
	@RequestMapping(value = "/existByIdNo/{idCardNo}", method = RequestMethod.GET, produces = MediaTypes.JSON_UTF_8)
	public Result forList(@PathVariable(value = "idCardNo")String idCardNo) {
		List<User> users= this.userManager.find("from User where idCardNo = ? ", idCardNo);
