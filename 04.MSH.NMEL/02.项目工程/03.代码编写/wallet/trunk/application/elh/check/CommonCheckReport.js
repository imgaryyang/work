...
class ComChkReport extends Component {
	...
	async fetchData () {
		...
		try {
			...
			// console.log('checkdetailoooooooooooooooooooo');
			// console.log(responseData);
			// console.log('11111111111111111111');
			// console.log(responseData.result.applyDoctor);
			// console.log('222222222222222222222222');
			// console.log(responseData.result.deptName);
				...
				<ScrollView style = {styles.scrollView,styles.container} keyboardShouldPersistTaps = {true}>
					...
					<View style = {[styles.itemRow]}>
						...
						<View style = {{flex:1}}>
							...
							<Text style = {[styles.itemRowText4, ]}>检验仪器：{this.state.chkListInfo.machine}</Text>
						</View>
					</View>
				</ScrollView>
			</View>
