		...
		/*let portrait = (
			<Animated.View style = {{
				...
				top: this.state.scrollY.interpolate({
	                ...
	                outputRange: [sbh + 54, sbh + 54, sbh + (44 - 26) / 2]
	            }),
	            left: this.state.scrollY.interpolate({
	                inputRange: [-(picBgHeight), 0, (picBgHeight)],
	                outputRange: [Global.getScreen().width / 2 - 25, Global.getScreen().width / 2 - 25, 100]
	            }),
			}} >
				<Portrait imageSource = {require('../../res/images/hosp/doctors/h01doc01.jpg')} 
			...
			<View style = {Global._styles.CONTAINER} >
				...
				<ScrollView 
					...
					<View style = {{alignItems: 'center', height: picBgHeight, paddingTop: sbh + 25}} >
						<Portrait imageSource = {{uri: Global._host + IMAGES_URL + this.props.doc.portrait,}} 
							width = {50} height = {50} radius = {25} bgColor = 'rgba(102,51,0,.5)' 
