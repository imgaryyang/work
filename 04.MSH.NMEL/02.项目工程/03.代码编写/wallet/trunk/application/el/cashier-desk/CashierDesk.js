                ...
                <ScrollView style={styles.sv} keyboardShouldPersistTaps={true}>
                    ...
                    <View style={styles.rend_row}>
                        ...
                        <View style={{flex: 1, alignItems: 'flex-end', paddingRight: 30}}>
                            <Text style={{textAlign:'left', fontSize:25, color: Global._colors.FONT}}>{parseFloat(this.state.payAmt).toFixed(2)}元</Text>
                        </View>
                    </View>
                    ...
                    <View style={[styles.rend_row, {height:30}]}>
                        <Text style={{fontSize:14}}>使用医保个人账户余额支付</Text>
                    </View>
                    <Checkbox iconSize='normal' size={20} style={[styles.rend_row, {height:100}]}
                        checked={this.state.checked=='0'?true:false}
                        onPress={()=>this.setState({
                            checked :'0' 
                        })}>
                            <Portrait imageSource={require('../../res/images/pay/0101.jpg')} width = {96} height={60} radius={5}/>
                            <View>
                                <Text style={{marginLeft: 12, fontSize:12}}>360203198409032058</Text>
                                <Text style={{marginLeft: 12, fontSize:12}}>医保账户余额: 568.99</Text>
                            </View>
                    </Checkbox>
                    ...
                    <View style={[styles.rend_row, {height:30}]}>
                        <Text style={{fontSize:14}}>使用其他支付方式支付</Text>
                    </View>

                    <Checkbox iconSize='normal' size={20} style={styles.rend_row} 
                    ...
                    <Checkbox style={styles.rend_row} iconSize='normal' size={20} 
                        checked={this.state.checked=='2'?true:false}
                        onPress={()=>this.setState({
                            checked :'2' 
                        })}>
                            <Portrait style={{margin:5}} imageSource={require('../../res/images/pay/alipay.png')} width = {48} height={30} left={0} radius={5}/>
                            <Text style={{flex:1, marginLeft: 28, fontSize:16}}>支付宝</Text>
                    </Checkbox>
                    <View style={Global._styles.PLACEHOLDER10} />
