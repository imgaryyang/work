            ...
            <View style = {[Global._styles.CONTAINER]} >
                ...
                <ScrollView style = {styles.scrollView} >
                    ...
                    <Form ref = {(c) => this.form = c} onChange = {this.onChange} value = {this.state.value} showLabel = {false}>
                        <Form.TextInput label="支付密码" name = "PayPassword"  placeholder = "请输入您的支付密码" password = {true} required = {true} icon = "md-lock" />
                        <Form.TextInput label="再次输入支付密码" name = "PayPassword2"  placeholder = "请再次输入您的支付密码" password = {true} required = {true} icon = "md-lock" />
                    </Form>
