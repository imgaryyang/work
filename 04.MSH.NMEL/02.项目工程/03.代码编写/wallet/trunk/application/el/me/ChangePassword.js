            ...
            <View style = {[Global._styles.CONTAINER]} >
                ...
                <ScrollView style = {styles.scrollView} >
                    ...
                    <Form ref = {(c) => this.form = c} onChange = {this.onChange} value = {this.state.value} showLabel = {false}>
                        <Form.TextInput name = "password"  label="原登陆密码" placeholder = "输入原登陆密码"  autoFocus={true} password = {true} required = {true} icon = "md-lock" />
                        <Form.TextInput name = "password1"  label="新登陆密码" placeholder = "请输入新登陆密码"  password = {true} required = {true} icon = "md-lock" />
                        <Form.TextInput name = "password2"  label="再次输入新登陆密码" placeholder = "请再次输入新登陆密码" password = {true} required = {true} icon = "md-lock" />
                    </Form>
