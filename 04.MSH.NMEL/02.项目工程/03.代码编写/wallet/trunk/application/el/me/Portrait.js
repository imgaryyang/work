...
class Portrait extends Component{
	...
	componentWillReceiveProps () {
		// console.log("portrait--------------componentWillReceiveProps");
		this.setState({
			userInfo: this.props.userInfo,
		});
	}
	...
	async savePhoto() {
		...
		try {
			// console.log("HSAFDSFDSFASDFASDFSDADS8*************************");
	...
	async updatePortrait (){
			// console.log("portrait---------------------"+this.state.userInfo.portrait);
			...
			<View style = {Global._styles.CONTAINER} >
                ...
                <ScrollView style={[styles.scrollView]} alwaysBounceVertical={true}>
					...
					<TouchableOpacity style={[ styles.buttonHolder, Global._styles.CENTER]} onPress={this.takePhoto} >
						<Icon iconLib='fa' name={'camera'} size={22} color={Global._colors.IOS_ARROW} style={[styles.icon, Global._styles.ICON]} />
