...
class SecuritySettings extends Component {
    ...
    getList () {
        if( this.props.userInfo.payPassword && this.props.userInfo.payPassword == '1'){
            return [
            ...
            {title: '重置支付密码',     component: CheckAuthCode, passProps:{ userInfo:this.props.userInfo, nextComponent: FindPayPassword,nextPassProps: 'value.mobile',nextTitle: '重置支付密码',title: "重置支付密码",isMobileExist:true},},
            {title: '修改手势密码',     component: SetGesturePassword},
