...
import ELPHome		from '../../store/shoppingCart/List';
import SalaryList	from '../../store/Index';
 ...
 */
const services = [
	{code: '001', name: '商城', 		icon: 'salary',  component: SalaryList, 	hideNavBar: true, navTitle: '商城',},
	{code: '002', name: '购物车', 	icon: 'pay', 	 component: ELPHome, 		hideNavBar: true, navTitle: '购物车',},
	...
	{code: '005', name: '医保', 		icon: 'si',		 component: SIServices, 	hideNavBar: true, navTitle: '医保',},
