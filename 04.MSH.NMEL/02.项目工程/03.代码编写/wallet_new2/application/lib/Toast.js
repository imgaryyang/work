...
export default class Toast extends Component {
    ...
    render () {
        return (
            <Animated.View style = {[styles.toastContainer, {top: this.state.msg ? 120 : Dimensions.get('window').height, opacity: this.state.fadeAnim}]} >
                <View style = {[styles.msgContainer, styles.center]} >
