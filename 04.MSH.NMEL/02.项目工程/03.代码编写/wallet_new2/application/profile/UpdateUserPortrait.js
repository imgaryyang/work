...
export default class UpdateUserPortrait extends Component {
    ...
    render() {
        var portraitImage = (this.state.avatarSource == null && this.state.userInfo.portrait == null) ? 
							require('./images/user_portrait.png') : 
							(this.state.avatarSource != null ?this.state.avatarSource : {uri: Global._host + IMAGES_URL + this.state.userInfo.portrait} );
        return (
