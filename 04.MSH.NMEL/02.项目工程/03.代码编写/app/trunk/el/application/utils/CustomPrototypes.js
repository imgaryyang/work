...
Object.defineProperty(Component.prototype, 'getEmptyView', {
	 ...
	 */
	value: function({condition, msg, reloadMsg, reloadCallback, buttons, style}) {
		...
		if(cond) {
			...
			let msgText = msg ? msg : '暂无相关数据';
			if(typeof reloadCallback == 'function') msgText += '，' + (reloadMsg ? reloadMsg : '点击刷新按钮重新查询');
