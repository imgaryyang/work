...
class EasyFrom extends Component {
    ...
    onChange (fieldName, fieldValue) {
        ...
        if(this.props.onChange)
            this.props.onChange(fieldName, fieldValue, value);
    }
    ...
    renderChildren () {
        ...
        let registerChild = this.registerChild;
        ...
        return children.map(
            (item, idx) => {
                ...
                if(item.type.displayName == '_EasyTextInputField_' 
                    ...
                    return React.cloneElement(item, {key, config, onChange, registerChild, value});
