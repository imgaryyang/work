            ...
            <View style = {[Global._styles.CONTAINER]} >
                ...
                <ScrollView style = {styles.scrollView} keyboardShouldPersistTaps = {true}>
                    ...
                    <Form ref = {(c) => this.form = c} onChange = {this.onChange} value = {this.state.value} showLabel = {false}>
                        <Form.TextInput name = "payPasswordOld" label="原支付密码" placeholder = "请输入您的原支付密码" maxLength = {6} minLength = {6}  autoFocus={true} password = {true} required = {true} icon = "md-lock" />
                        <Form.TextInput name = "payPassword"  label="新支付密码"  placeholder = "请输入您的新支付密码" maxLength = {6} minLength = {6} password = {true} required = {true} icon = "md-lock" />
                        <Form.TextInput name = "payPassword2" label="再次输入新支付密码" placeholder = "请再次输入您的新支付密码" maxLength = {6} minLength = {6} password = {true} required = {true} icon = "md-lock" />
                    </Form>
