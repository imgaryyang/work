...
class RegisterGesturePassword extends Component {

    static displayName = 'RegisterGesturePassword';
    static description = '注册设置手势密码';
    ...
    async startRegister() {
        try {
            ...
            let responseData = await this.request(`${Global._host}el/user/register`, {
                body: JSON.stringify({
            ...
            UserAction.login(responseData.result, null);
            this.toast('注册成功');
...
export default RegisterGesturePassword;
