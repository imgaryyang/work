...
import RegisterGesturePassword from './RegisterGesturePassword';
...
export default class Register extends Component {
    ...
    constructor(props) {
        super(props);
        this.title = this.props.cardno ? '完善个人资料' : '注册';
        this.timer = null;
        this.state = {
            tel: null,
            ...
            modalVisible: this.props.cardno ? true : false,
            cardno: null,
        }
        if (this.props.cardno) {
            let cardno1 = this.props.cardno.substring(0, 4);
            let cardno2 = this.props.cardno.substring(this.props.cardno.length - 4);
            this.state.cardno = cardno1 + ' **** ' + cardno2;
        }
    }
    ...
    async getVerificationCode() {
        ...
        let url = `${Global._host}el/user/genCheckCode/${this.state.tel}?isMobileExist=false`;
        let options = {
            method: 'GET'
        };
    ...
    async toNext() {
        ...
        try {
            ...
            this.props.navigator.push({
                component: RegisterGesturePassword,
                hideNavBar: true,
                passProps: {
                    tel: this.state.tel,
                ...
                <Modal
                    ...
                    <View style={styles.promptContainer}>
                        <Text style={styles.promptText}>
                            尊敬的{this.state.cardno}用户您好：
                        </Text>
                        <Text style={[styles.promptText, styles.promptText2]}>
                            使用民生钱包前，请先完善您的个人信息。
                        </Text>
                        <TouchableOpacity
                            ...
                            <Text style={styles.btnTxt}>去完善</Text>
                        </TouchableOpacity>
                    </View>
                </Modal>
            </View>
