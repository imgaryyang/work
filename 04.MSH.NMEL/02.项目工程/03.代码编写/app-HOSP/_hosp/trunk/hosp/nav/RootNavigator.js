...
import Toast 			from 'elapp/lib/Toast';
import Loading 			from 'elapp/lib/Loading';
import InputPwd			from 'elapp/lib/sec/InputPwd'
import InputPwdStore 	from 'elapp/flux/InputPwdStore';
...
import Login 			from 'elapp/el/me/Login';
...
export default class RootNavigator extends Component {
    ...
    */
	...
	onOpenMessage(message) {
		let extra = message._data['cn.jpush.android.EXTRA'];
		let data = JSON.parse(extra);
		console.log('jpush',data);
	}
