...
import Profile      	from 'elapp/el/me/Profile';
import SetPatternLock   from 'elapp/el/me/SetPatternLock';
import SecuritySettings from 'elapp/el/me/SecuritySettings';
//积分 信用值
import ContactUs      	from 'elapp/el/me/ContactUs';
import AboutUs      	from './AboutUs';
import Suggest      	from 'elapp/el/me/Suggest';
import Logoff           from 'elapp/el/me/Logoff';

import UserAction       from 'elapp/flux/UserAction';
import AuthAction       from 'elapp/flux/AuthAction';
import UserStore        from 'elapp/flux/UserStore';
import AuthStore        from 'elapp/flux/AuthStore';

import CardList      	from 'elapp/el/card/CardList';
import PatientList      from 'elapp/elh/patients/PatientsList';
import NewsList      	from 'elapp/el/common/news/NewsList';

import SampleMenu       from 'elapp/tmp/sample/SampleMenu';
...
const icons = {
    'profile':	require('../res/images/base/me/points.png'),
    'card':		require('../res/images/base/me/card.png'),
	'patient':	require('../res/images/base/me/patient.png'),
...
class Me extends Component {
	...
	getList () {
    	return [
			{text: '个人资料',   		icon: 'profile',	bg: '#fe80c4',	component: Profile},
			{text: '我的卡包',		icon: 'card',		bg: '#ffa122',	component: CardList, passProps: {hideBackButton: false, runInTab: false}},
			{text: '常用就诊人',		icon: 'patient',	bg: '#ff6866',	component: PatientList},
			{text: '消息中心',		icon: 'msg',		bg: '#8a90f9',	component: NewsList},
			{text: '安全设置',		icon: 'security',	bg: '#fed02f',	component: SecuritySettings, separator: true, passProps: {userInfo: this.state.userInfo, backRoute:this.state.route}},
            ...
            {text: '清空session数据',icon: 'exit',   		bg: '#04d3be',  func: this.clear},
			{text: '样例',	    	icon: 'exit',		bg: '#04d3be',  component: SampleMenu},
	    ];
    }
    async clear () {
