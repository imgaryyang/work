            ...
            let responseData = 
                {
                    ...
                    'result': {
                        "version": "v 1.0.1",
                        "content": "“掌上蒙医”是一个基于内蒙社会保障卡实名认证，建立居民相关薪资发放、挂号就医、缴费等民生活动为一体的应用平台，未来还将逐步丰富公共服务、个人消费等领域",
                    }
                };
                ...
                <ScrollView>
                    ...
                    <View style={Global._styles.CENTER}>
                        <Image resizeMode='contain' 
                            style={[styles.logo]} 
                            source = {Global._logo['l']} />
                    </View>
                    <View style={Global._styles.PLACEHOLDER20} />
                    <View style={Global._styles.FULL_SEP_LINE} />
                    <View style={[styles.holder1]}>
                        <Text>掌上蒙医  v 1.0.1</Text>
                    </View>
                    <View style={Global._styles.FULL_SEP_LINE} />
                    <View style={Global._styles.PLACEHOLDER20} />
                    <View style={Global._styles.FULL_SEP_LINE} />
                    <View style={[styles.holder2]}>
                        <Text>“掌上蒙医”是一个基于内蒙社会保障卡实名认证，建立居民相关薪资发放、挂号就医、缴费等民生活动为一体的应用平台，未来还将逐步丰富公共服务、个人消费等领域。</Text>
                    </View>
                    <View style={Global._styles.FULL_SEP_LINE} />
                    <View style={Global._styles.PLACEHOLDER20} />
