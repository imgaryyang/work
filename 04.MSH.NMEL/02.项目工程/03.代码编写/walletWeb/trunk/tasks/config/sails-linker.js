  ...
  grunt.config.set('sails-linker', {
    devJs: {
      options: {
        ...
        appRoot: '.tmp/public/web'
      },
      files: {
        '.tmp/public/web/**/*.html': require('../pipeline').jsFilesToInject,
    ...
    prodJs: {
      ...
      files: {
        '.tmp/public/web/**/*.html': ['.tmp/public/web/min/production.min.js'],
        'views/**/*.html': ['.tmp/public/web/min/production.min.js'],
        'views/**/*.ejs': ['.tmp/public/web/min/production.min.js']
      }
    },
    ...
    devStyles: {
      ...
      files: {
        '.tmp/public/web/**/*.html': require('../pipeline').cssFilesToInject,
    ...
    prodStyles: {
      ...
      files: {
        '.tmp/public/web/index.html': ['.tmp/public/web/min/production.min.css'],
        'views/**/*.html': ['.tmp/public/web/min/production.min.css'],
        'views/**/*.ejs': ['.tmp/public/web/min/production.min.css']
      }
    },
    ...
    devTpl: {
      ...
      files: {
        '.tmp/public/web/index.html': ['.tmp/public/web/jst.js'],
        'views/**/*.html': ['.tmp/public/web/jst.js'],
        'views/**/*.ejs': ['.tmp/public/web/jst.js']
      }
    },
    ...
    prodJsJade: {
      ...
      files: {
        'views/**/*.jade': ['.tmp/public/web/min/production.min.js']
      }
    },
    ...
    prodStylesJade: {
      ...
      files: {
        'views/**/*.jade': ['.tmp/public/web/min/production.min.css']
      }
    },
    ...
    devTplJade: {
      ...
      files: {
        'views/**/*.jade': ['.tmp/public/web/jst.js']
      }
    }
  });
