 ...
 * the web root (`.tmp/public/web`) so they can be served via HTTP,
 ...
 * hidden directory located `.tmp/public/web`.
 *
 * #### Via the `build` tasklist (`sails www`)
 * Copies all directories and files from the .tmp/public/web directory into a www directory.
 *
 * For usage docs see:
