package com.lenovohit.hcp.payment.support.alipay.config;
...
public class Configs {
	...
	private static String localCheckDir; // 对账文件路径
	...
	public synchronized static void init(String filePath) {
		...
		localCheckDir = configs.getString("local_check_dir");
	...
	public static String getLocalCheckDir() {
		return localCheckDir;
	}

	public static void setLocalCheckDir(String localCheckDir) {
		Configs.localCheckDir = localCheckDir;
	}
