package com.lenovohit.hcp.payment.support.alipay.model.builder;

import java.util.List;

import com.google.gson.annotations.SerializedName;
import com.lenovohit.core.utils.StringUtils;
import com.lenovohit.hcp.payment.support.alipay.model.ExtendParams;
import com.lenovohit.hcp.payment.support.alipay.model.GoodsDetail;
...
public class AlipayTradePrecreateRequestBuilder extends RequestBuilder {
	...
	public boolean validate() {
		...
		/*
		 * if (StringUtils.isEmpty(bizContent.storeId)) { throw new
		 * NullPointerException("store_id should not be NULL!"); }
		 */
		return true;
	}
