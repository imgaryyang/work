...
public class MatStoreInfoRestController extends HcpBaseRestController {
	...
	public Result forPage(@PathVariable("start") String start, @PathVariable("limit") String limit,
		...
		if(!StringUtils.isEmpty(storeQuery.getTradeName())){
			jql.append("and (store.tradeName like ? or material.commonSpell like ? or material.commonName like ?  or material.commonWb like ? or store.materialCode like ? or material.barcode = ? ) ");
