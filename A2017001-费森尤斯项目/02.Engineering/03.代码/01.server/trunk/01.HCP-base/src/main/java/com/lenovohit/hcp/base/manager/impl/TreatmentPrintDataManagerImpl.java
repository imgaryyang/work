...
@Service("treatmentPrintDataManager")
public class TreatmentPrintDataManagerImpl extends AbstractPrintDataManagerImpl {
	@Autowired
	...
	public PrintData getPrintData(String bizId, HcpUser user) {
		...
		for (MedicalOrder m : orders) {
			if (MedicalOrder.DRUG_FLAG_NON_DRUG.equals(m.getDrugFlag()))
			{
