...
@Entity
@Table(name = "MATERIAL_MONTHCHECK") // 药房药库 - 库存信息表月结快照
public class MatMonthCheck extends HcpBaseModel {
	...
	private Date monthcheckTime;
	private String monthcheckOpera;
	...
	@ManyToOne // (cascade=(CascadeType.REFRESH))
				// 要把matStoreInfo.id传回来，就不会报级联相关错误
	...
	@JsonFormat(pattern = "yyyy-MM-dd", timezone = "GMT+8")
	public Date getMonthcheckTime() {
		return monthcheckTime;
	}

	public void setMonthcheckTime(Date monthcheckTime) {
		this.monthcheckTime = monthcheckTime;
	}

	public String getMonthcheckOpera() {
		return monthcheckOpera;
	}

	public void setMonthcheckOpera(String monthcheckOpera) {
		this.monthcheckOpera = monthcheckOpera;
	}
