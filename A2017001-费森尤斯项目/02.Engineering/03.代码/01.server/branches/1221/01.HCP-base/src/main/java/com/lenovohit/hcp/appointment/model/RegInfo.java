...
public class RegInfo extends HcpBaseModel {
	...
	private List<PhaRecipe> recipeList;
	@Transient
	...
	@Transient
	public List<OutpatientChargeDetail> getDetails() {
		return details;
	}

	public void setDetails(List<OutpatientChargeDetail> details) {
		this.details = details;
	}
    
	@Transient
	public List<PhaRecipe> getRecipeList() {
		return recipeList;
	}

	public void setRecipeList(List<PhaRecipe> recipeList) {
