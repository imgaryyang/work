...
@Entity
@Table(name = "DRUG_PRICE_VIEW") // 药库基本信息和价格视图
public class PhaDrugPriceView extends BaseIdModel {
	...
	private String hosId;	 //基础信息医院id
	private String priceId;		//价格表id
	private String pHosId;	 //价格信息医院id
	...
	public String getpHosId() {
		return pHosId;
	}

	public void setpHosId(String pHosId) {
		this.pHosId = pHosId;
	}
