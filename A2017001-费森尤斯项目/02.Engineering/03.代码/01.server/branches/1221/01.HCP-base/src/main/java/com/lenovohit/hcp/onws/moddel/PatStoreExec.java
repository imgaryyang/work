...
@Entity
@Table(name = "PHA_PATSTORE_EXEC")
public class PatStoreExec extends HcpBaseModel {
	...
	private Integer execSubno;//单内序号
	...
	public Integer getExecSubno() {
		return execSubno;
	}

	public void setExecSubno(Integer execSubno) {
