 ...
 */
@Entity
@Table(name = "TEST_TREAT_DOCTOR")
public class TestDoctor extends BaseIdModel implements java.io.Serializable {
    /** 版本号 */
    ...
    private TestDepartment deptment;
	...
	@Transient
	public TestDepartment getDeptment() {
		return deptment;
	}

	public void setDeptment(TestDepartment deptment) {
