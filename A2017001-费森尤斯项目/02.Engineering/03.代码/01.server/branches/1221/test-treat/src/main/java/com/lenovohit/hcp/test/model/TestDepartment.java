 ...
 */
@Entity
@Table(name = "TEST_TREAT_DEPARTMENT")
public class TestDepartment extends BaseIdModel implements java.io.Serializable {
    /** 版本号 */
    ...
    private TestDepartment parent;
    
    private Set<TestDepartment> children;
	...
	@Transient
	public TestDepartment getParent() {
		return parent;
	}

	public void setParent(TestDepartment parent) {
		this.parent = parent;
	}

	@Transient
	public Set<TestDepartment> getChildren() {
		return children;
	}

	public void setChildren(Set<TestDepartment> children) {
