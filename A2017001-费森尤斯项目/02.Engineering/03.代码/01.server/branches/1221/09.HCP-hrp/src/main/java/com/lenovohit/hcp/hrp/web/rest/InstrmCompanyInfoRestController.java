...
@RestController
@RequestMapping("/hcp/hrp/settings/instrmMng")
public class InstrmCompanyInfoRestController extends HcpBaseRestController {
	...
	public Result forCreateMenu(@RequestBody String data){
		...
		model.setCompanyWb(WubiUtil.getWBCode(model.getCompanyWb()));
		//TODO 校验
	...
	public Result forListCompany(@RequestParam(value = "data", defaultValue = "") String data) {
		...
		List<Company> models = matCompanyInfoManager.find(jql.toString());
