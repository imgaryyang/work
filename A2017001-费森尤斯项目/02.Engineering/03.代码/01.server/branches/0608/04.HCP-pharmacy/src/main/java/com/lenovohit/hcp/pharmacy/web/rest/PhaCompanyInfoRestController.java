...
@RestController
@RequestMapping("/hcp/pharmacy/settings/manufacturerMng")
public class PhaCompanyInfoRestController extends HcpBaseRestController {
	...
	public Result forPage(@PathVariable("start") String start, @PathVariable("limit") String limit,
		...
		StringBuilder jql = new StringBuilder( "from PhaCompanyInfo where 1=1 ");
		...
		phaCompanyInfoManager.findPage(page);
	...
	public Result forInfo(@PathVariable("id") String id){
		Company model= phaCompanyInfoManager.get(id);
	...
	public Result forList(@RequestParam(value = "data", defaultValue = "") String data) {
		List<Company> models = phaCompanyInfoManager.findAll();
	...
	public Result forCreateMenu(@RequestBody String data){
		...
		//TODO 校验
		Company saved = this.phaCompanyInfoManager.save(model);
	...
	public Result forUpdate(@RequestBody String data) {
		...
		model.setCompanySpell(PinyinUtil.getFirstSpell(model.getCompanyName()));
		model.setCompanyWb(WubiUtil.getWBCode(model.getCompanyName()));
		this.phaCompanyInfoManager.save(model);
	...
	public Result forDeleteMenu(@PathVariable("id") String id){
		try {
			this.phaCompanyInfoManager.delete(id);
		} catch (Exception e) {
	...
	public Result forDeleteAll(@RequestBody String data){
		...
		try {
			...
			this.phaCompanyInfoManager.executeSql(idSql.toString(), idvalues.toArray());
		} catch (Exception e) {
			e.printStackTrace();
			throw new BaseException("删除失败");
		}
	...
	public Result forListCompany(@RequestParam(value = "data", defaultValue = "") String data) {
		StringBuilder jql = new StringBuilder( " from PhaCompanyInfo where companyType = '2' ");
	
		List<Company> models = phaCompanyInfoManager.find(jql.toString());
