...
public class HCPConstants {
	...
	public final static Map<String, RedisSequenceConfig> SEQUENCE_RULE = new HashMap<String, RedisSequenceConfig>() {
		private static final long serialVersionUID = 1L;
		{
			...
			put("B_COMPANY_COMPANY_CODE", 			new RedisSequenceConfig(RedisSequenceConfig.SEQ_TYPE_FIXED_STRING, "C", 13)); 			//厂商id：		C 0000000000001
			...
			put("REG_INFO_REG_ID", 					new RedisSequenceConfig(RedisSequenceConfig.SEQ_TYPE_DATE_STRING, "R", 5)); 			//就诊流水号：		R YYYYMMDD 00001
			put("PHA_PATIENTSTORE_EXEC_EXEC_NO", 	new RedisSequenceConfig(RedisSequenceConfig.SEQ_TYPE_DATE_STRING, "E", 5)); 			//保管执行单单号：		E YYYYMMDD 00001
			...
			put("OW_ORDER_ORDER_ID", 				new RedisSequenceConfig(RedisSequenceConfig.SEQ_TYPE_DATE_STRING, "O", 5)); 			//医嘱id：		O YYYYMMDD 00001
			put("OW_ORDER_RECIPE_ID", 				new RedisSequenceConfig(RedisSequenceConfig.SEQ_TYPE_DATE_STRING, "R", 5)); 			//医嘱id：		R YYYYMMDD 00001
