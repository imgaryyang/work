package com.lenovohit.hcp.base.dto;
...
/**
 * 打印数据dto，为无意义的打印字段，以后如果不够可以增加记录
 * @description
 * @author jatesun
 * @version 1.0.0
 * @date 2017年5月6日
...
public class PrintData {
	...
	private String t19;
	private String t20;
	private Map<String, List<InnerData>> map;// 对应列表打印的map
	...
	public Map<String, List<InnerData>> getMap() {
		return map;
	}

	public void setMap(Map<String, List<InnerData>> map) {
		this.map = map;
	}
