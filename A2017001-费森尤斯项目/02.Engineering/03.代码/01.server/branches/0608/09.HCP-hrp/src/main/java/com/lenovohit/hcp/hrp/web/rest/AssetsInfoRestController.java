...
@RestController
@RequestMapping("/hcp/hrp/settings/assetInfo")
public class AssetsInfoRestController extends HcpBaseRestController {
	...
	public Result forPage(@PathVariable("start") String start, @PathVariable("limit") String limit,
		...
		if (!StringUtils.isEmpty(query.getCommonName())) {
			jql.append("and (commonName like ? or commonSpell like ? or commonWb like ? )");
			values.add("%" + query.getCommonName() + "%");
			values.add("%" + query.getCommonName() + "%");
			values.add("%" + query.getCommonName() + "%");
		}
		/*if (!StringUtils.isEmpty(query.getTradeName())) {
			jql.append("and (tradeName like ? or tradeSpell like ? or tradeWb like ? )");
