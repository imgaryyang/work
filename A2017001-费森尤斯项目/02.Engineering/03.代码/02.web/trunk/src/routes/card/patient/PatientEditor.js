...
import { Card, Row, Col, Button, Form, Input, DatePicker, notification } from 'antd';
...
import IdCard from '../../../components/ScanIdCardInputReadAndSearch';
      ...
      <div>
        <Form >
          ...
          <div style={{ height: `${wsHeight - 10}px` }} className={styles.formContainer} >
            ...
            <FormItem style={{ display: 'none' }} >
              {getFieldDecorator('identityPic', {
                initialValue: patient.identityPic,
              })(
                <Input />,
              )}
            </FormItem>
              ...
              <Col span={8} style={{ paddingLeft: '3px' }} >
                <Card bodyStyle={{ padding: 0, paddingTop: '3px' }} >
                  <div className={styles.customImage} >
                    <img alt="example" width="100%" src={patient.identityPic} />
                  ...
                  <Col span={12} className={styles.formCol} >
                    ...
                    <FormItem label="身份证" {...formItemLayout} >
                      {getFieldDecorator('idNo', {
                        ...
                        <IdCard iconOnly maxLength={18} tabIndex={3} readed={this.readIdCardDone} isSearch={false} />,
                      )}
                    </FormItem>
            ...
            <FieldSet title="其他" >
              <Row >
                ...
                <Col span={8} className={styles.formCol} >
                  <FormItem label="传染病" {...formItemLayout} >
                    {getFieldDecorator('infectiousDisease', {
                      initialValue: patient.infectiousDisease,
                    })(
                      <DictSelect
                        style={{ width: '100%' }}
                        columnName="INFECTIOUS_DISEASE"
                        tabIndex={8}
                      />,
                    )}
                  </FormItem>
                ...
                {/* <Col span={8} className={styles.formCol} >
                  <FormItem label="停用标识" {...formItemLayout} >
                    {getFieldDecorator('stopFlag', {
                      ...
                      <DictRadioGroup colu／mnName="STOP_FLAG" />,
                    )}
                  </FormItem>
                </Col> */}
              </Row>
            ...
            <FieldSet title="转出记录" >
              <Row>
                <Col span={8} className={styles.formCol} >
                  <FormItem label="转出原因" {...formItemLayout} >
                    {getFieldDecorator('leaveCause', {
                      initialValue: patient.leaveCause,
                    })(
                      <DictSelect
                        style={{ width: '100%' }}
                        columnName="LEAVE_CAUSE"
                        tabIndex={8}
                      />,
                    )}
                  </FormItem>
                ...
                <Col span={8} className={styles.formCol} >
                  <FormItem label="转出日期" {...formItemLayout} >
                    {getFieldDecorator('leaveTime', {
                      initialValue: patient.leaveTime ? moment(patient.leaveTime) : null,
                    })(
                      <DatePicker style={{ width: '100%' }} tabIndex={7} />,
                    )}
                  </FormItem>
                ...
                <Col span={16} className={styles.formCol} >
                  <FormItem label="备注" {...twoColLayout} >
                    {getFieldDecorator('leaveRemark', {
                      initialValue: patient.leaveRemark,
                      rules: [
                        { max: 200, message: '备注不能超过200个字' },
                      ],
                    })(
                      <Input maxLength={200} type="textarea" rows={3} />,
                    )}
                  </FormItem>
                </Col>
              </Row>
          ...
          <div className={styles.bottomBtnContainer} >
            <Row>
              <Col span={24} style={{ textAlign: 'right' }} >
                ...
                <Button onClick={this.reset} icon="plus" size="large" >新建</Button>
              </Col>
            </Row>
          </div>
        </Form>
