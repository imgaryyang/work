...
class EditorForm extends Component {
  ...
  handleSubmit() {
    const { record, chanel } = this.props;
  ...
  render() {
    const { namespace, record, form, isSpin, visible, formCache, shortcuts, base, chanel } = this.props;
    ...
    // 集团管理可编辑内容和价格
    // 财务管理能编辑本院的价格   新增新的药品  (chanel === 'operate' || (chanel === 'medicine' && (record.hosId === base.user.hosId || typeof(record.hosId) === 'undefined') ))
    // 药房只能编辑本院的内容    (chanel === 'operate' || (chanel === 'medicine' && record.hosId === base.user.hosId ))
    const isFin = (chanel === 'operate' || (chanel === 'medicine' && (record.hosId === base.user.hosId || typeof(record.hosId) === 'undefined'))) ? false : true;
    const isMe = (chanel === 'operate' || (chanel === 'finance')) ? false : true;
      ...
      >
        <Spin spinning={isSpin}>
          <Form>
            ...
            <FormItem style={{ display: 'none' }}>
              {getFieldDecorator('priceId', { initialValue: record.priceId || '' })(<Input />)}
            </FormItem>
            <FormItem style={{ display: 'none' }}>
            ...
            <Row className={Styles.drugInfo}>
              <Col span={8}>
                ...
                <FormItem label="通用名称" {...formItemLayout}>
                  ...
                  })(<Input tabIndex="4" disabled={isFin} />) }
                </FormItem>
                ...
                <FormItem label="药品条码" {...formItemLayout}>
                  { getFieldDecorator('barcode', { initialValue: record.barcode })(<Input tabIndex="16" disabled={isFin} />) }
                </FormItem>
                <FormItem label="抗菌药编码" {...formItemLayout}>
                  { getFieldDecorator('antCode', { initialValue: record.antCode })(<Input tabIndex="19" disabled={isFin} />) }
                </FormItem>
                ...
                <FormItem label="含税进价" {...formItemLayout}>
                  { getFieldDecorator('taxBuyPrice', {
                    initialValue: record.taxBuyPrice,
                  })(
                    <NumberInput
                      numberType="currency4"
                      addonBefore="¥"
                ...
                <FormItem label="需要皮试" {...formItemLayout}>
                  {
                    getFieldDecorator('isskin', {
                      ...
                      <RadioGroup tabIndex="25" disabled={isFin}>
                        <Radio value>是</Radio>
              ...
              <Col span={8}>
                ...
                <FormItem label="商品名称" {...formItemLayout}>
                  { getFieldDecorator('tradeName', {
                    ...
                    )(<Input tabIndex="5" disabled={isFin} />) }
                </FormItem>
                ...
                <FormItem label="物价编码" {...formItemLayout}>
                  { getFieldDecorator('priceCode', { initialValue: record.priceCode })(<Input tabIndex="17" disabled={isFin} />) }
                </FormItem>
                ...
                <FormItem label="含税售价" {...formItemLayout}>
                  { getFieldDecorator('taxSalePrice', {
                    initialValue: record.taxSalePrice,
                  })(
                    <NumberInput
                      numberType="currency4"
                      addonBefore="¥"
                ...
                <FormItem label="处方药" {...formItemLayout}>
                  {
                    getFieldDecorator('isrecipe', {
                      ...
                      <RadioGroup tabIndex="26" disabled={isFin}>
                        <Radio value>是</Radio>
                        <Radio value={false}>否</Radio>
                      </RadioGroup>)
                    }
              ...
              <Col span={8}>
                <FormItem label="自定义码" {...formItemLayout}>
                  { getFieldDecorator('userCode', { initialValue: record.userCode })(<Input tabIndex="3" disabled={isFin} />) }
                </FormItem>
                <FormItem label="中心码" {...formItemLayout} >
                  ...
                  })(<Input style={{ width: '100%' }} maxLength={20} disabled={isFin} />) }
                </FormItem>
                ...
                <FormItem label="国药准字" {...formItemLayout}>
                  { getFieldDecorator('approvedId', { initialValue: record.approvedId })(<Input tabIndex="15" disabled={isFin} />) }
                </FormItem>
                ...
                <FormItem label="停用标志" {...formItemLayout}>
                  {
                    getFieldDecorator('stopFlag', {
                      ...
                      <RadioGroup tabIndex="27" disabled={isFin}>
