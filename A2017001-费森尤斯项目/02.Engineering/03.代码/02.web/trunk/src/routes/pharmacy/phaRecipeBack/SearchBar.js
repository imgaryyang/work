        ...
        <Row>
          <Col lg={24} md={24} sm={24} xs={24} className="action-form-searchbar">
            <Form inline>
              ...
              <FormItem>
                {getFieldDecorator('patientName')(<Input placeholder="姓名" onPressEnter={this.handleSubmit.bind(this)}/>)}
              </FormItem>
              <FormItem label="挂号日期">
                {
...
const SearchBarFrom = Form.create()(SearchBar);
export default connect(({ phaRecipe }) => ({ phaRecipe }))(SearchBarFrom);
