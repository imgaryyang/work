      ...
      <div className="action-form-wrapper">
        <Row type="flex">
          <Col span={20} className="action-form-searchbar">
            <Form inline >
              <FormItem>
                {getFieldDecorator('inType')(<DictSelect showSearch style={{ width: '100px' }} columnName="IN_TYPE" placeholder="入库类型" allowClear />)}
              </FormItem>
              <FormItem>
                {getFieldDecorator('deptId')(<DeptSelect showSearch style={{ width: '100px' }} deptType={['011']} placeholder="入库科室" allowClear />)}
              </FormItem>
              <FormItem>
