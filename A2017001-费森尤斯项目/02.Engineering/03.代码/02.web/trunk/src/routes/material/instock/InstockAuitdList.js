...
class InstockAuitdList extends Component {
  ...
  componentWillMount() {
    ...
    this.props.dispatch({
      type: 'instockDeptAuitd/loadBuyList',
      payload: {
  ...
  onConfirm(record) {
    this.props.dispatch({
      type: 'instockDeptAuitd/loadBuyDetail',
      payload: {
        query: {
  ...
  render() {
    const { buyList } = this.props.instockDeptAuitd;
...
export default connect(
  ({ base, instockDeptAuitd }) => ({ base, instockDeptAuitd }),
)(InstockAuitdList);
