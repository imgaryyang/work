  ...
  render() {
    ...
    const storeSumCompute = (record) => {
      if (record.storeSum != null) {
        if (record.materialInfo && record.materialInfo.materialUnit !== null) {
          return `${record.storeSum}${record.materialInfo.materialUnit}`;
        } else {
    ...
    const alertNumCompute = (record) => {
      if (record.alertNum != null) {
        if (record.materialInfo && record.materialInfo.materialUnit !== null) {
          return `${record.alertNum}${record.materialInfo.materialUnit}`;
        } else {
