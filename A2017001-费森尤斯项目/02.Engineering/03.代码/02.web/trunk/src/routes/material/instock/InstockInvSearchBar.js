...
class InstockInvSearchBar extends Component {
  ...
  render() {
    ...
    const { instockDept } = this.props;
    const { dataApply,fromDeptId } = (instockDept || {});
...
export default connect(
  ({ instockDept, utils }) => ({ instockDept, utils }),
