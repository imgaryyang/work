...
class DictSelectCell extends Component {
  ...
  componentDidMount() {
	  var input = this.refs.wrapper.childNodes[0].childNodes[0].childNodes[0].childNodes[0].childNodes[1].childNodes[0].childNodes[0]
...
//	  }
  ...
  render() {
    ...
    var { addonAfter,editorConfig } = this.props;
