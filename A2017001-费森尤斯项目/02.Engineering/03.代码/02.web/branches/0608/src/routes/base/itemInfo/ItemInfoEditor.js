...
class EditorForm extends React.Component {
  ...
  render() {
    ...
    const flagItemLayout = { labelCol: { span: 9 }, wrapperCol: { span: 15 } };
        ...
        <Spin spinning={spin}>
          <Form style={{ paddingRight: 20 }} >
            ...
            <Row>
              <Col span={8}>
                <FormItem label="项目名称" {...formItemLayout}>
                  ...
                  })(<Input ref={(node) => { this.itemNameInput = node; }} />) }
                </FormItem>
              </Col>
              <Col span={8}>
            ...
            <Row>
              ...
              <Col span={5}>
                <FormItem label="复合项目" {...flagItemLayout}>
                  { getFieldDecorator('isgather', {
                    initialValue: typeof data.defaulted === 'undefined' ? false : data.defaulted,
                  })(
                    <RadioGroup>
                      <Radio value>是</Radio>
              ...
              <Col span={5}>
                <FormItem label="执行确认" {...flagItemLayout}>
              ...
              <Col span={6}>
                <FormItem label="停用标志" {...flagItemLayout}>
