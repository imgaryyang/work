            ...
            <div className="action-form-wrapper">
              <Row type="flex" gutter={24} justify="end">
                <Col className="action-form-operating">
                  <Button type="primary" size="large" onClick={this.onSearch} className="on-add">
                    <Icon type="search" />查询
                  </Button>
                  <Button
                    type="primary" ghost
                    onClick={this.handleUnCheckout}
                    size="large" className="on-add"
                    disabled={isDisabled}
                  >
                    <Icon type="pay-circle-o" />取消结账
                  </Button>
                  <Button type="primary" size="large" onClick={this.printInvoice.bind(this)} className="on-add">
                    <Icon type="printer" />发票打印
                  </Button>
                  <Button type="primary" size="large" onClick={this.print.bind(this)} className="on-add">
