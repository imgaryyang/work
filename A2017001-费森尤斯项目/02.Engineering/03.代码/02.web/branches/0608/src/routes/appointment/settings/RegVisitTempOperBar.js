      ...
      <div className="action-form-wrapper">
        <Row gutter={24}>
          ...
          <Col lg={12} md={12} sm={16} xs={24} className="action-form-operating">
            <Button type="primary" size="large" className="on-add" onClick={onAdd.bind(this)}>
              <Icon type="plus" />新增
            </Button>
            <Button type="danger" size="large" className="on-delete" onClick={onDeleteAll.bind(this)}>
              <Icon type="delete" />删除
            </Button>
          </Col>
        </Row>
