        ...
        <Form inline className={styles.form} >
          <Card className={styles.inputCard} >
            <div>
              <Row>
                <Col span={8} >
                  <FormItem style={{ width: '100%' }} label="搜索药物" {...formItemLayout} >
                    {getFieldDecorator('allergicMed', {
                      initialValue: formValue.allergicMed,
                    })(
                ...
                <Col span={8} >
                  <FormItem style={{ display: 'none' }} >
                    {getFieldDecorator('itemCode', {
                      initialValue: formValue.item.id,
                    })(<Input />)}
                  </FormItem>
                  <FormItem style={{ width: '100%' }} label="过敏药物" {...formItemLayout} >
                    {getFieldDecorator('itemName', {
                      initialValue: formValue.item.itemName,
                    })(
                      <Input disabled tabIndex={2} />,
                    )}
                  </FormItem>
                </Col>
                <Col span={8} >
                  <FormItem style={{ width: '100%', paddingLeft: '30px' }} wrapperCol={{ span: 24 }} >
              ...
              <Row>
                <Col span={24} >
                  <FormItem style={{ width: '100%' }} label="备注信息" {...formItemLayoutColSpan} >
                    {getFieldDecorator('memo', {
                      initialValue: formValue.memo,
                    })(
                      <Input tabIndex={4} maxLength={100} disabled={disabled} />,
                    )}
                  </FormItem>
                </Col>
              </Row>
