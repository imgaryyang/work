          ...
          <Col span={5} >
            <FormItem label="就诊类别" {...formItemLayout} >
              { getFieldDecorator('feeType', { initialValue: dicts.dis('FEE_TYPE', userInfo.feeType) })(
                <DictSelect showSearch onSelect={this.onFeeType.bind(this)} columnName="FEE_TYPE" tabIndex="1" placeholder="就诊类别" />,
              )}
            </FormItem>
          </Col>
          <Col span={5} >
        ...
        <Row style={{ marginTop: 5 }}>
          <Col span={5} >
            <FormItem label="处方分类" {...formItemLayout} >
              { getFieldDecorator('groupType', { initialValue: '1' })(<DictSelect showSearch={false} onChange={this.changeDrugType.bind(this)} columnName="GROUP_TYPE" tabIndex="1" placeholder="处方分类" />)}
            </FormItem>
          </Col>
          <Col span={5} >
