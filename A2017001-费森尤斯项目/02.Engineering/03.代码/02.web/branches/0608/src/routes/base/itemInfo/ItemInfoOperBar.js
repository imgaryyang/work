      ...
      <div className="action-form-wrapper">
        ...
        <Row>
          <Col span={16} className="action-form-searchbar">
            <Form inline>
              <FormItem>
                {getFieldDecorator('itemName')(<Input placeholder="项目名称/拼音/五笔" />)}
              </FormItem>
              <FormItem>
          ...
          <Col span={8} className="action-form-operating">
            <Button type="primary" size="large" icon="plus" onClick={this.onAdd.bind(this)} className="on-add">新增</Button>
            <Button type="danger" size="large" icon="delete" onClick={this.onDeleteAll.bind(this)} className="on-delete">删除</Button>
          </Col>
        </Row>
      </div>
    );
