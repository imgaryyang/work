...
class CheckSearchBar extends Component {
  ...
  // 打印
  handlePrint() {
	  	const search = this.props.bill;
	  	console.info('tiger 8 ',search);
	    Modal.confirm({
	        content: '确定要打印盘点单吗？',
	        okText: '确定',
	        cancelText: '取消',
        ...
        <Row type="flex" justify="left">
          <Col span={20} className="action-form-searchbar">
            <Form inline >
              ...
              <FormItem>
                {getFieldDecorator('materialType')(<DictSelect showSearch style={{ width: '150px' }} columnName="MATERIAL_TYPE" placeholder="物资类型" />)}
              </FormItem>
              <FormItem>
          ...
          <Col span={4} className="action-form-operating">
            <Button size="large" className="btn-left" onClick={addCheckInfo} icon="pushpin-o" >封账</Button>
            <Button size="large" className="btn-left" onClick={() => this.handlePrint()} icon="printer" >打印</Button>
            <Button size="large" className="btn-left" onClick={saveCheckInfo} icon="cloud-upload-o" >暂存</Button>
