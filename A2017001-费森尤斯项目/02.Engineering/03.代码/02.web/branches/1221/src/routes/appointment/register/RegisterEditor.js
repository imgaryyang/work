...
class EditorForm extends Component {
  ...
  constructor(props) {
    ...
    this.readIdCardDone = ::this.readIdCardDone;
  }
  ...
  readIdCardDone(info) {
    this.props.form.resetFields(['idNo', 'name', 'sex', 'birthday', 'mobile', 'idAddress']);
    this.props.dispatch({
      type: 'register/setState',
      payload: {
        patient: { ...this.props.patient, ...info },
            ...
            <div className="action-form-wrapper">
              <Row type="flex" gutter={24} justify="end">
                <Col className="action-form-operating">
                  ...
                  <Button onClick={this.handleReset} size="large" className="btn-left">
                    <Icon type="reload" />重置
                  </Button>
                  <Button type="primary" onClick={this.handleReg} size="large" ghost className="btn-right">
