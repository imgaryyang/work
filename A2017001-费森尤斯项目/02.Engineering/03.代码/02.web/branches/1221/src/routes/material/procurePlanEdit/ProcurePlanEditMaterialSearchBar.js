...
class ProcurePlanEditDrugSearchBar extends Component {
...
const ProcurePlanEditDrugSearchBarForm = Form.create()(ProcurePlanEditDrugSearchBar);
export default connect()(ProcurePlanEditDrugSearchBarForm);
