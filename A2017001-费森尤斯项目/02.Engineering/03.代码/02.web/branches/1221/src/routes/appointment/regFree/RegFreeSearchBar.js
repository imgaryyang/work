        ...
        <Row type="flex" justify="left">
          <Col span={20} className="action-form-searchbar">
            <Form inline >
              ...
              <FormItem>
                {getFieldDecorator('regLevel', { initialValue: '1' })(<DictSelect onSelect={this.changeRegLevel.bind(this)} showSearch style={{ width: '250px' }} columnName="REG_LEVEL" placeholder="挂号类型"  allowClear = 'true'/>)}
              </FormItem>
              <FormItem style={{ width: '300px' }} {...formItemLayout}>
                {getFieldDecorator('item')(<CommonItemSearchInput placeholder="费用拼音码/五笔码" itemType="0" onSelect={this.onSelectCommonItem.bind(this)}  allowClear = 'true'/>)}
              </FormItem>
            </Form>
          </Col>
        </Row>
