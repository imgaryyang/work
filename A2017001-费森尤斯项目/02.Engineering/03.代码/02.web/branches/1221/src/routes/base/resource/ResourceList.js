...
class ResourceList extends React.Component {
	...
	render(){
		...
		var {page,data,selectedRowKeys} = resource;
...
export default connect(({resource})=>({resource}))(ResourceList);
