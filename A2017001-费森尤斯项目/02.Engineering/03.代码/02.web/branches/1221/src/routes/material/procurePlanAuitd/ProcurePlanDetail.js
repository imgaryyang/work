  ...
  render() {
    ...
    const columns = [
      ...
      { title: '本科库存',
        ...
        key: 'deptSum',
        width: '80px',
        render: (text, record) => (record.deptSum ? record.deptSum : 0 + record.matInfo.materialUnit === null ?record.matInfo.materialUnit : 0),
      },
      { title: '本院库存',
        dataIndex: 'totalSum',
        key: 'totalSum',
        width: '80px',
        render: (text, record) => (
          record.totalSum ? record.totalSum:0 + record.matInfo.materialUnit === null ? '':record.matInfo.materialUnit : 0
        ),
      },
      { title: '审核数量',
        dataIndex: 'auitdNum',
