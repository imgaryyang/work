...
const _API_ROOT = "/api/hcp/material/directIn/";
const _COMPANY = "/api/hcp/material/settings/manufacturerMng/";
...
加载物资入库汇总page
 */
export async function inStoreSummary(start, limit, query) {
  return ajax.GET(`${_API_ROOT}InStoreSummaryPage/${start}/${limit}`, query || {});
}
/*
加载入库汇总page
 */
...
加载物资入库汇总总额page
 */
export async function loadInputSummarySum(query) {
  return ajax.GET(`${_API_ROOT}inputSummarySum`, query || {});
}
/*
查询入库明细page
 */
export async function inStoreDetailPage(start, limit, query) {
  return ajax.GET(`${_API_ROOT}/InStoreDetailPage/${start}/${limit}`, query || {});
}
/*
查询入库单page
 */
export async function inStoreBillPage(start, limit, query) {
  return ajax.GET(`${_API_ROOT}InStoreBillPage/${start}/${limit}`, query || {});
}
// 加载暂存请领记录
