...
export async function loadBuyHistory(start, limit, query) {
	return ajax.GET(`${apiRoot.matDirectIn}/page/${start}/${limit}`, query || {});
}
...
export async function saveDirectIn(data) {
   //console.info('saveDirectIn : ',data);
...
export async function inStoreSummaryPage(start, limit, query) {
  return ajax.GET(`${apiRoot.matDirectIn}/InStoreSummaryPage/${start}/${limit}`, query || {});
}
/*
查询入库明细page
 */
export async function inStoreDetailPage(start, limit, query) {
	return ajax.GET(`${apiRoot.matDirectIn}/InStoreDetailPage/${start}/${limit}`, query || {});
}
//加载暂存请领记录
...
export async function exportDetailToExcel(query) {
	return ajax.GET(`${apiRoot.matDirectIn}/exportDetailToExcel`, query || {});
}
/*
入库信息按供应商汇总导出到Excel中
 */
export async function exportInStoreSummary(query) {
	return ajax.GET(`${apiRoot.matDirectIn}/exportInStoreSummary`, query || {});
}
