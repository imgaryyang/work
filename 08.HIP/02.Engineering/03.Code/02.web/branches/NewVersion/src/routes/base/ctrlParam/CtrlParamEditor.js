      ...
      >
        <Spin spinning={spin}>
          <Form>
            ...
            <Row>
              <Col span={24} >
                <Item label="控制分类" {...formItemLayout} >
                ...
                <Item label="控制id" {...formItemLayout} >
                ...
                <Item label="控制说明" {...formItemLayout} >
                ...
                <Item label="控制参数" {...formItemLayout} >
                ...
                <Item label="停用标志" {...formItemLayout} >
