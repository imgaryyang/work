      ...
      return (
        <div>
          <Row>
            ...
            <Col span={8} >
              <Item label="身份证号" {...formItemLayout}>
                {
          ...
          <Row>
            <Col span={8} >
              <Item label="婚姻状态" {...formItemLayout}>
                {
          ...
          <Row>
            <Col span={24} >
              <Item label="家庭住址" labelCol={{ span: 2 }} wrapperCol={{ span: 22 }} >
                {
      ...
      return (
        <div>
          <Row>
            ...
            <Col span={8}>
              <Item label="所属病区" {...formItemLayout} >
                {
            ...
            <Col span={8}>
              <Item label="员工类型" {...formItemLayout} >
                {
          ...
          <Row>
            <Col span={8} >
              <Item label="所属科室" {...formItemLayout} >
                {
            ...
            <Col span={8} >
              <Item label="登录科室" {...formItemLayout} >
                {
            ...
            <Col span={8}>
              <Item label="权限级别" {...formItemLayout} >
                {
          ...
          <Row>
            <Col span={8}>
              <Item label="HR编号" {...formItemLayout}>
                {
          ...
          <Row>
            <Col span={8} >
              <Item label="执业证书编号" {...formItemLayout}>
                {
            ...
            <Col span={16}>
              <Item label="备注" labelCol={{ span: 3 }} wrapperCol={{ span: 21 }} >
                {
        ...
        <Spin spinning={editorSpin} >
          <Form >
            ...
            <Tabs defaultActiveKey="base" size="small">
              ...
              <TabPane tab={'培训经历'} disabled={isCreate} key={'training'} >
                <UserTraining userId={record.id} />
              </TabPane>
