...
class RoleSearchBar extends Component {
  ...
  render() {
    ...
    return (
      <Form inline>
        <FormItem>
          {getFieldDecorator('name')(<Input placeholder="名称" style={{ width: '120px' }} onPressEnter={this.handleSubmit.bind(this)} />)}
        </FormItem>
          <FormItem>
            {getFieldDecorator('code')(<Input placeholder="编码" style={{ width: '100px' }} onPressEnter={this.handleSubmit.bind(this)} />)}
          </FormItem>
            <FormItem>
