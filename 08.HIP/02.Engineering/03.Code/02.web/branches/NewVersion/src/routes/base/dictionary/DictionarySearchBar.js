        ...
        <FormItem style={{ display: 'none' }} >
          ...
          <FormItem style={{ display: 'none' }} >
            ...
            initialValue: selectedType.type === '2' ? selectedType.dis : '',
              ...
              <FormItem>
                {getFieldDecorator('columnGroup')(<Input placeholder="分组/类别名" onPressEnter={this.handleSubmit} />)}
              </FormItem>
                <FormItem>
                  {getFieldDecorator('columnName')(<Input placeholder="类别码" onPressEnter={this.handleSubmit} />)}
                </FormItem>
                  <FormItem>
                    {getFieldDecorator('columnKey')(<Input placeholder="键" onPressEnter={this.handleSubmit} />)}
                  </FormItem>
                    <FormItem>
                      {getFieldDecorator('columnVal')(<Input placeholder="值" onPressEnter={this.handleSubmit} />)}
                    </FormItem>
                      <FormItem>
