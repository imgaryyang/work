        ...
        <FormItem style={{ display: 'none' }} >
          ...
          <FormItem style={{ display: 'none' }} >
            ...
            initialValue: selectedType.type === '2' ? selectedType.dis : '',
              ...
              <FormItem>
                {getFieldDecorator('controlId')(<Input placeholder="控制id" onPressEnter={this.handleSubmit} />)}
              </FormItem>
                <FormItem>
                  {getFieldDecorator('controlNote')(<Input placeholder="控制说明" onPressEnter={this.handleSubmit} />)}
                </FormItem>
                  <FormItem>
