...
class ScanMedicalCardInput extends Component {
  ...
  render() {
    ...
    return (
      <Input ref="scanMedicalCardInput" onBlur={this.read} onPressEnter={this.onPressEnter} {...rest} maxLength={20} />
    );
  }
}

export default connect(({ utils }) => ({ utils }))(ScanMedicalCardInput);
