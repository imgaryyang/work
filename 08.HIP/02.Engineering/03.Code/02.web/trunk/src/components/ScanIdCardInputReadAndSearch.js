...
class ScanIdCardInputReadAndSearch extends Component {
  ...
  onPressEnter() {
    console.info(111)
    const inputValue = this.refs.scanIdCardInputOnlyRead.props.value;
  ...
  */
  ...
  render() {
    ...
    const rest = _.omit(this.props, ['iconOnly', 'dispatch', 'readed', 'isSearch', 'onPressEnter', 'utils', 'isRead']);
    ...
    return (
      <Input ref="scanIdCardInputOnlyRead" addonAfter={button} onPressEnter={this.onPressEnter} onBlur={this.onPressEnter} {...rest} maxLength={18} />
    );
  }
}
