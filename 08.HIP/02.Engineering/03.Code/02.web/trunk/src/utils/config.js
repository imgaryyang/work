const config = {
  apiRoot: {
    ...
    interfaceConfig: '/api/hcp/base/interfaceConfig/', // 接口配置
    print: '/api/hcp/base/print/', // 打印
    chargePkg: '/api/hcp/base/chargePkg/', // 收费组套
    messageNotification: '/api/hcp/base/messageNotification', // 消息提示
    complexItemInfo: '/api/hcp/base/complexItemInfo', // 复合项目维护
    userTraining: '/api/hcp/base/trainExperience', // 用户培训经历
    /* appointment */
    ...
    financeStatistics: '/api/hcp/finance/statistics/',
    monthCheck: '/api/hcp/material/monthCheck/',
    ...
    phaLis: '/api/hcp/onws/phaPatlis',  // 送检添加
    phaLisResult: '/api/hcp/onws/phaLisResult',  // 送检添加
    miHisCompare: '/api/hcp/base/miHisCompare',  // 送检添加
  },
};
