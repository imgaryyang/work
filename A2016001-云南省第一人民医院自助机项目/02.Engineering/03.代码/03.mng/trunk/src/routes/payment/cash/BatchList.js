...
class BatchList extends Component {
  ...
  render() {
    ...
    const columns = [
      ...
      { title: '总笔数', dataIndex: 'count', key: 'count', width: 80},
      { title: '清钞金额', dataIndex: 'amt', key: 'amt', width: 80, render: (value) => { 
    	  return value?value.formatMoney():'0'.formatMoney();
      }},
      { title: '点钞金额', dataIndex: 'bankAmt', key: 'bankAmt', width: 80, render: (value) => { 
    	  return value?value.formatMoney():'0'.formatMoney();
      }},
      { title: '机器名称', dataIndex: 'machineName', key: 'machineName', width: 100 },
