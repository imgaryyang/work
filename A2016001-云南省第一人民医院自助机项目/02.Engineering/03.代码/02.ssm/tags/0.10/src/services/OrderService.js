...
export async function loadOrderList () {
  return ajax.GET(_API_ROOT + 'order/loadOrderList');
}
...
export async function prepaid (payload) {
  return ajax.GET(_API_ROOT + 'prepaid/other', payload);
}
...
export async function inpatientPrepaid (payload) {
  return ajax.GET(_API_ROOT + 'inpatient/prepaid', payload);
}
...
export async function loadNeedPay () {
  return ajax.GET(_API_ROOT + 'order/loadNeedPay');
}
