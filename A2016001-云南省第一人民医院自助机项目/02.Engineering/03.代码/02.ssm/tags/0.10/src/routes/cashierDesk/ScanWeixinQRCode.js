...
import styles               from './ScanWeixinQRCode.css';
...
class ScanWeixinQRCode extends React.Component {

  static displayName = 'ScanWeixinQRCode';
  static description = '微信扫码支付';
...
export default connect(({account, order, message}) => ({account, order, message}))(ScanWeixinQRCode);
