...
const availableDaysLen = config.appointment.availableAppointDays;
const appointToday = config.appointment.appointToday;

class InpatientCalendar extends React.Component {

  static displayName = 'InpatientCalendar';
  static description = '住院日历';
...
export default connect()(InpatientCalendar);
