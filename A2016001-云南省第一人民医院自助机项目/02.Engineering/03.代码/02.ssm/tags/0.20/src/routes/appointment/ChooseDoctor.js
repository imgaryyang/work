		...
		<WorkSpace fullScreen = {true} >
			...
			<Row>
				<Col span = {8} className = {styles.toolBarItem} style = {{paddingRight: '.5rem'}} >
					<Card shadow = {true} onClick = {this.showDatePicker} ><img src = {calendarIcon} />{dateText} </Card>
				</Col>
				<Col span = {8} className = {styles.toolBarItem} style = {{paddingRight: '.5rem', paddingLeft: '.5rem'}} >
					<Card shadow = {true} onClick = {this.showDayPeriodPicker} ><img src = {alltimeIcon} />{dayPeriodText}</Card>
				</Col>
				<Col span = {8} className = {styles.toolBarItem} style = {{paddingLeft: '.5rem'}} >
					<Card shadow = {true} onClick = {this.showDoctorPicker} ><img src = {searchIcon} />{doctorText}</Card>
				</Col>
			</Row>
			</ToolBar>
