...
//预约
import ChooseDepartment   from './routes/appointment/ChooseDepartment';
...
//收银台
import CashierDesk        from './routes/cashierDesk/CashierDesk';
import PayChannels        from './routes/cashierDesk/PayChannels';
...
return (
	<Router history={history}>
		<Route path="/" component={Framework}>
			...
			<Route path="/schedule" component={ ChooseDepartment }/>
			...
			<Route path="/cashierDesk" component={ CashierDesk }>
				<IndexRoute component={PayChannels}/>
				<Route path="payChannels" component={ PayChannels }/>
