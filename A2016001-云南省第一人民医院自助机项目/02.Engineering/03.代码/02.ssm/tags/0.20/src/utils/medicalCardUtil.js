...
const DEVICE_dev = {
		LH_IDC_OpenDevice:function(){setTimeout(()=>{DEVICE_dev_state = 2 },1*1000); return "{\"nHandle\":0}"},
		...
		LH_IDC_M1ReadBlock:function(){return "{\"stateCode\":0,\"idNo\": \"421022190809111833\", \"name\": \"张三\",\"cardNo\":\"421022190809111833\"}"},
...
function listenCard(){
	...
	if(status == 2){//卡在内部
		//popCard(nHandle);
		if(dev_mode){}//TODO 是否所有的都要3s后读取		
		setTimeout(()=>{//3秒钟后读取，用于让语音执行完毕
