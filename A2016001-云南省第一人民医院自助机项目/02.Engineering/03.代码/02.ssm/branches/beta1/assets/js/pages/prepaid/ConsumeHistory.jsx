  ...
  render() {
    ...
    return (
      <NavContainer title='消费记录' onBack={this.onBack} onHome={this.onHome} >
		  ...
		  <Row>
	          <Col span = {8} className = 'list_title' >发生时间</Col>
	          <Col span = {4} className = 'list_title list_center' >支付人</Col>
	          <Col span = {8} className = 'list_title list_amt' >金额</Col>
	          <Col span = {4} className = 'list_title' >操作类型</Col>
	      </Row>
        ...
        return (
          <div key = {'_order_items_' + idx} className = 'comsume_row' >
  	          <Row type="flex" align="middle" >
		          <Col span = {8} className = 'list_item' >
		          	{moment(time).format('YYYY-MM-DD HH:mm')}
		          </Col>
		          <Col span = {4} className = 'list_item list_center' >
		          	{patientName}
		          </Col>
		          <Col span = {8} className = 'list_item list_amt' >
		            {amt}
		          </Col>
