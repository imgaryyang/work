...
class UnionPay extends React.Component {
	...
	constructor(props) {
		...
		this.readPin = this.readPin.bind(this);
		this.pay = this.pay.bind(this);
		this.payDone = this.payDone.bind(this);
		this.afterPay = this.afterPay.bind(this);
		this.payError = this.payError.bind(this);
		
		this.pinChange = this.pinChange.bind(this);
		this.pinTimeout = this.pinTimeout.bind(this);
		this.pinCancel = this.pinCancel.bind(this);
		this.pinEnter = this.pinEnter.bind(this);
		this.pinError = this.pinError.bind(this);	
