...
public class PayChannel extends BaseIdModel{
	...
	private String checkUrl;//[ftp:ip:port：user:password:dir];[http:url];[https:url];[socket:ip:port];[query]
	private String checkTime;
	private String refCheckUrl;//[ftp:ip:port：user:password:dir];[http:url];[https:url];[socket:ip:port];[query]
	private String refCheckTime;
	private String retCheckUrl;//[ftp:ip:port：user:password:dir];[http:url];[https:url];[socket:ip:port];[query]
	...
	private String memo;
	private String openTimeInterval;//交易时间控制 startTime|endTime
	...
	public String getOpenTimeInterval() {
		return openTimeInterval;
	}
	public void setOpenTimeInterval(String openTimeInterval) {
