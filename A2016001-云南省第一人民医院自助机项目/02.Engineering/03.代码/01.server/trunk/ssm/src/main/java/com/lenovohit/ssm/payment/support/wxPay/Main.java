...
import com.lenovohit.ssm.payment.support.wxPay.protocol.getsignkey_protocol.GetsignkeyReqData;
import com.lenovohit.ssm.payment.support.wxPay.service.GetsignkeyService;
...
public class Main {
    ...
    public static void main(String[] args) {
        try {
        	GetsignkeyReqData  reqData = new GetsignkeyReqData();
...
//          WXPay.doScanPayBusiness(scanPayReqData, resultListener);	
            ...
            //--------------------------------------------------------------------
            //温馨提示，第一次使用该SDK时请到com.lenovohit.ssm.payment.support.wxPay.common.Configure类里面进行配置
            //--------------------------------------------------------------------
