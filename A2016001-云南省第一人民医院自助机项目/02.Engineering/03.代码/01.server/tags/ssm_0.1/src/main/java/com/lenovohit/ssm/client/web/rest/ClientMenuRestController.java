 ...
 */
@RestController
@RequestMapping("/ssm/client/menu")
public class ClientMenuRestController extends BaseRestController {
	...
	public Result forMyList(@RequestParam(value = "data", defaultValue = "") String data) {
		List<ClientMenu> menus = clientMenuManager.find("from ClientMenu where 1=1 order by sort");
		return ResultUtils.renderSuccessResult(menus);
	}
