...
//import com.lenovohit.ssm.app.base.model.News;
//import com.lenovohit.ssm.base.model.Org;
//
//@RestController
//@RequestMapping("/ssm/el/base/news/")
...
//		}
//		Date now = new Date();
//		model.setUpdatedAt(DateUtils.date2String(now, "yyy-MM-dd hh:mm:ss"));
//		model.setCreatedAt(DateUtils.date2String(now, "yyy-MM-dd hh:mm:ss"));
