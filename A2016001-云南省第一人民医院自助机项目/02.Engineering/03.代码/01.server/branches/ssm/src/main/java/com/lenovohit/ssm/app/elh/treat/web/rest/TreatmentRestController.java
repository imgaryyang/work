...
import com.lenovohit.ssm.app.elh.treat.model.CheckDetail;
import com.lenovohit.ssm.app.elh.treat.model.Diagnosis;
import com.lenovohit.ssm.app.elh.treat.model.DrugDetail;
import com.lenovohit.ssm.app.elh.treat.model.DrugOrder;
import com.lenovohit.ssm.app.elh.treat.model.MedicalCheck;
import com.lenovohit.ssm.app.elh.treat.model.Register;
import com.lenovohit.ssm.app.elh.treat.model.TreatDetail;
import com.lenovohit.ssm.app.elh.treat.model.Treatment;
import com.lenovohit.ssm.app.elh.treat.vom.DiagnosisVom;
import com.lenovohit.ssm.app.elh.treat.vom.DrugOrderVom;
import com.lenovohit.ssm.app.elh.treat.vom.MedicalCheckVom;
import com.lenovohit.ssm.app.elh.treat.vom.RegisterVom;
 ...
 */
@RestController
@RequestMapping("/hwe/app/treatment")
public class TreatmentRestController extends BaseRestController {
	...
	public Result forPatientList(@PathVariable(value = "start") String start, @PathVariable(value = "pageSize") String pageSize,
...
//		String orgId = loginOrg.getId();
		String orgId = "8a8c7d9b55298217015529a9844e0000";
		AppPatient patient = JSONUtils.deserialize(data, AppPatient.class);
		StringBuilder sb = new StringBuilder("select distinct t from AppPatient t,Treatment treat where treat.patientId = t.id and treat.hospitalId = ? ");
		...
		this.appPatientManager.findPage(page);
	...
	public Result forRegisterList(@PathVariable(value = "start") String start,
...
//		Org loginOrg = (Org)this.getSession().getAttribute(Constants.ORG_KEY);
//		if(null==loginOrg || "".equals(loginOrg)){
//			return ResultUtils.renderFailureResult("未找到当前登录机构3");
//		}
...
//		}
	...
	public Result forDiagnosisList(@PathVariable(value = "start") String start,
			@PathVariable(value = "pageSize") String pageSize,
			@RequestParam(value = "data", defaultValue = "") String data) {
//		Org loginOrg = (Org)this.getSession().getAttribute(Constants.ORG_KEY);
//		if(null==loginOrg || "".equals(loginOrg)){
...
//		}
	...
	public Result forMedicalCheckList(@PathVariable(value = "start") String start,
			@PathVariable(value = "pageSize") String pageSize,
			@RequestParam(value = "data", defaultValue = "") String data) {
//		Org loginOrg = (Org)this.getSession().getAttribute(Constants.ORG_KEY);
//		if(null==loginOrg || "".equals(loginOrg)){
...
//		}
	...
	public Result forDrugOrderList(@PathVariable(value = "start") String start,
			@PathVariable(value = "pageSize") String pageSize,
			@RequestParam(value = "data", defaultValue = "") String data) {
		
//		Org loginOrg = (Org)this.getSession().getAttribute(Constants.ORG_KEY);
//		if(null==loginOrg || "".equals(loginOrg)){
//			return ResultUtils.renderFailureResult("未找到当前登录机构8");
//		}
//		String orgId = loginOrg.getId();
		String orgId = "";
...
//		Org loginOrg = (Org)this.getSession().getAttribute(Constants.ORG_KEY);
//		if(null==loginOrg || "".equals(loginOrg)){
//			return ResultUtils.renderFailureResult("未找到当前登录机构9");
//		}
		TreatDetail td = treatDetailManager.get(id);
//		if(!loginOrg.getId().equals(td.getHospitalId())){
//			return ResultUtils.renderFailureResult("无权查看其它医院的挂号记录");
//		}
	...
	public Result forListTreatment(@PathVariable(value = "start") String start,
			@PathVariable(value = "pageSize") String pageSize,
			@RequestParam(value = "data", defaultValue = "") String data) {
//		Org loginOrg = (Org)this.getSession().getAttribute(Constants.ORG_KEY);
//		if(null==loginOrg || "".equals(loginOrg)){
//			return ResultUtils.renderFailureResult("未找到当前登录机构0");
//		}
//		String orgId = loginOrg.getId();
		String orgId = "";
...
//		Org loginOrg = (Org)this.getSession().getAttribute(Constants.ORG_KEY);
//		if(null==loginOrg || "".equals(loginOrg)){
//			return ResultUtils.renderFailureResult("未找到当前登录机构11");
//		}
//		String orgId = loginOrg.getId();
//		String orgId = "";
...
//		}
	...
	public Result forMyMedicalCheckList(@PathVariable(value = "start") String start,
			@PathVariable(value = "pageSize") String pageSize,
			@RequestParam(value = "data", defaultValue = "") String data) {
...
//		String userId = _user.getId();
	...
	public Result forMyDrugOrderList(@PathVariable(value = "start") String start,
			@PathVariable(value = "pageSize") String pageSize,
			@RequestParam(value = "data", defaultValue = "") String data) {
	...
	private Result forMyTreatmentList(Map<String,String> params) {
		...
		try {
			...
			for(Object row : result){
				...
				AppDepartment department = this.parseDepartment(vlaues, 23+18+21);//11
...
//				userPatient.setId(tm.getPatientId());
	...
	private AppDepartment parseDepartment(Object[] values,int start){
		AppDepartment dept = new AppDepartment();
