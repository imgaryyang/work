...
import com.lenovohit.ssm.treat.manager.TmsManager;

/**
 * 
 * @author Exorics
 */
public class TmsManangerImpl<T extends Model, ID extends Serializable> implements TmsManager<T, ID> {

	TmsDao<T, ID> dao;

	public TmsManangerImpl(final TmsDao<T, ID> dao) {
		super();
		this.dao = dao;
	}
