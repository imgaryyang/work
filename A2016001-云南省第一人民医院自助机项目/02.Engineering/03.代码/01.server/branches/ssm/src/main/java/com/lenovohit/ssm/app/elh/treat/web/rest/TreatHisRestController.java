...
//import com.lenovohit.ssm.app.base.model.AppNotice;
...
//import com.lenovohit.ssm.app.elh.treat.model.Cure;
...
//import com.lenovohit.ssm.app.elh.treat.vom.ChecksTom;
//import com.lenovohit.ssm.app.elh.treat.vom.CureVom;
...
//import com.lenovohit.ssm.app.elh.treat.vom.TreatmentAndRegister;
//
//
///**
// * 就医接口<br>
...
// */
//@RestController
//@RequestMapping("/ssm/app/elh/his")
//public class TreatHisRestController extends BaseRestController  {
//	@Autowired
//	private NoticeService noticeService;
//	@Autowired
//	private GenericManager<AppNotice, String> noticeManager;
//	
//	@Autowired
...
//	@Autowired
//	private GenericManager<AppDepartment, String> departmentManager;
//	
//	/**
...
//			//完善数据
//			List<AppDepartment> depts = this.departmentManager.find("from Department where idHlht = ? ", checkVom.getDepartment());
...
//			notice.setMode(AppNotice.NOT_MODE_APP);
//			notice.setType(AppNotice.NOT_TYPE_APP_GUI);
...
//			notice.setState(AppNotice.NOT_STATUE_SENT);
