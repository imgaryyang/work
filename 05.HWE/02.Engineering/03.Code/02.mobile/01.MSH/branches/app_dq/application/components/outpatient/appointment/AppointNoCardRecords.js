...
class AppointNoCardRecords extends Component {
  static displayName = 'AppointNoCardRecords';
  static description = '无卡预约记录';
  ...
  async fetchData(hospital) {
    ...
    try {
      if (ctrlState.refreshing) {
        ...
        const { result, success, msg } = await forReservedNoCardList({ hosNo, terminalUser, startDate });
...
export default AppointNoCardRecords;
