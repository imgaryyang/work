    ...
    return (
      <View style={[styles.container, style]}>
        ...
        <View style={styles.row}>
          ...
          <Text style={styles.contentText}>{clinicDate}  {weekday}  {shiftName}  {clinicTime.slice(11, 16)}</Text>
        </View>
        <View style={styles.row}>
        ...
        <View style={styles.row}>
          ...
          <Text style={[styles.contentText, styles.orange]}>{`${totalFee}元`}</Text>
        </View>
      </View>
    );
  }
