...
export async function getEdition() {
  return getItem(Storage.KEY.EDITION);
}
export async function setEdition(edition) {
  setItem(Storage.KEY.EDITION, edition);
}
export async function removeEdition() {
  removeItem(Storage.KEY.EDITION);
}
