          ...
          <ScrollView style={styles.scrollView} >
            <Card fullWidth style={{ borderTopWidth: 0 }} >
              ...
              <Card fullWidth noPadding >
                  ...
                  <Text style={styles.detail}>{filterHtmlForWiki(value.projectIntroduction || '暂无工程信息介绍')}</Text>
              </Card>
            <Sep height={15} />
            <Card fullWidth noPadding >
              <View style={styles.cardTitle}>
              ...
              <Text style={styles.detail}>{filterHtmlForWiki(value.referenceValue || '暂无成分信息介绍')}</Text>
            </Card>
            <Sep height={15} />
              <Card fullWidth noPadding >
                  <View style={styles.cardTitle}>
                  ...
                  <Text style={styles.detail}>{filterHtmlForWiki(value.clinicalSignificance || '暂无成分信息介绍')}</Text>
              </Card>
          </ScrollView>
        </View>
      );
