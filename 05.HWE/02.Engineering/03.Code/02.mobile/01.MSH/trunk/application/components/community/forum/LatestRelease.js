...
class LatestRelease extends Component {
  static displayName = 'LatestRelease';
  static description = '最新发布';
  ...
  render() {
    if (!this.state.doRenderScene) {
      return LatestRelease.renderPlaceholderView();
    }
...
export default connect(mapStateToProps, mapDispatchToProps)(LatestRelease);
