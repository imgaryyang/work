...
import com.lenovohit.hwe.pay.support.alipay.model.GoodsDetail;

/**
 * Created by liuyangkly on 16/3/3.
 */
public class AlipayTradeCreateRequestBuilder extends AbsAlipayTradeRequestBuilder {
    ...
    @Override
	public AlipayTradeCreateRequestBuilder setConfigs(Configuration configs) {
		return (AlipayTradeCreateRequestBuilder) super.setConfigs(configs);
	}
    ...
    public AlipayTradeCreateRequestBuilder setUndiscountableAmount(String undiscountableAmount) {
    ...
    public AlipayTradeCreateRequestBuilder setAlipayStoreId(String alipayStoreId) {
