...
import com.lenovohit.hwe.pay.support.wxpay.common.XMLParser;
...
public class RefundQueryBusiness {
    ...
    private static List<RefundOrderData> orderList = null;
    ...
    public void run(RefundQueryReqData refundQueryReqData,RefundQueryBusiness.ResultListener resultListener) throws Exception {
        ...
        refundQueryResData.setResponseString(refundQueryServiceResponseString);
        refundQueryResData.setConfigs(refundQueryReqData.getConfigs());
...
//        }
        ...
        if (refundQueryResData.getReturn_code().equals("FAIL")) {
            ...
            //--------------------------------------------------------------------
            String key = refundQueryReqData.getConfigs().getString("key");
            if (!Signature.checkIsSignValidFromResponseString(key, refundQueryServiceResponseString)) {
            ...
            if (refundQueryResData.getResult_code().equals("FAIL")) {
                log.e("出错，错误码：" + refundQueryResData.getErr_code() + "     错误信息：" + refundQueryResData.getErr_code_des());
                ...
                refundQueryResData.setOrderList(orderList);
