 ...
 */
public class AlipayTradePrecreateRequestBuilder extends AbsAlipayTradeRequestBuilder {
    ...
    @Override
	public AlipayTradePrecreateRequestBuilder setConfigs(Configuration configs) {
		return (AlipayTradePrecreateRequestBuilder) super.setConfigs(configs);
	}
