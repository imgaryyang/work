...
import com.lenovohit.hwe.pay.support.alipay.model.hb.*;
import com.lenovohit.hwe.pay.support.alipay.utils.Utils;

/**
 * Created by liuyangkly on 16/3/2.
 */
public class AlipayHeartbeatSynRequestBuilder extends AbsAlipayTradeRequestBuilder {
    ...
    @Override
	public AlipayHeartbeatSynRequestBuilder setConfigs(Configuration configs) {
		return (AlipayHeartbeatSynRequestBuilder) super.setConfigs(configs);
	}
