...
@Service("cacctpayCheckService")
public class CacctpayCheckServiceImpl implements CheckBaseService {
    private static Log                  log = LogFactory.getLog(CacctpayCheckServiceImpl.class);
