...
import com.lenovohit.hwe.pay.support.alipay.utils.GsonFactory;

/**
 * Created by liuyangkly on 15/7/31.
 */
public abstract class AbsAlipayTradeRequestBuilder {
	 //接口配置
    ...
    public AbsAlipayTradeRequestBuilder setAppAuthToken(String appAuthToken) {
    ...
    public AbsAlipayTradeRequestBuilder setNotifyUrl(String notifyUrl) {
	...
	public AbsAlipayTradeRequestBuilder setConfigs(Configuration configs) {
