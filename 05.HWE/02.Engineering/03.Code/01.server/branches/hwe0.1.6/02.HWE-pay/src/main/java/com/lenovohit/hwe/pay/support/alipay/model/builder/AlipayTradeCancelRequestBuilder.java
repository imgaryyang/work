 ...
 */
public class AlipayTradeCancelRequestBuilder extends AbsAlipayTradeRequestBuilder {
    ...
    @Override
	public AlipayTradeCancelRequestBuilder setConfigs(Configuration configs) {
		return (AlipayTradeCancelRequestBuilder) super.setConfigs(configs);
	}
