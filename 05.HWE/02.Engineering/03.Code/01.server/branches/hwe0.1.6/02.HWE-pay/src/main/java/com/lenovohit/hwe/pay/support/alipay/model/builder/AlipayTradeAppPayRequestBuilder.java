...
import com.lenovohit.hwe.pay.support.alipay.model.ExtendParams;

/**
 * Created by liuyangkly on 16/3/3.
 */
public class AlipayTradeAppPayRequestBuilder extends AbsAlipayTradeRequestBuilder {
    ...
    public boolean validate() {
        ...
        if (StringUtils.isEmpty(bizContent.productCode)) {
    ...
    @Override
    public AlipayTradeAppPayRequestBuilder setAppAuthToken(String appAuthToken) {
        return (AlipayTradeAppPayRequestBuilder) super.setAppAuthToken(appAuthToken);
    }
    ...
    @Override
	public AlipayTradeAppPayRequestBuilder setConfigs(Configuration configs) {
		return (AlipayTradeAppPayRequestBuilder) super.setConfigs(configs);
	}
    ...
    public AlipayTradeAppPayRequestBuilder setProductCode(String productCode) {
    ...
    public AlipayTradeAppPayRequestBuilder setGoodsType(String goodsType) {
    ...
    public AlipayTradeAppPayRequestBuilder setPassbackParams(String passbackParams) {
    ...
    public AlipayTradeAppPayRequestBuilder setPromoParams(String promoParams) {
    ...
    public AlipayTradeAppPayRequestBuilder setEnablePayChannels(String enablePayChannels) {
    ...
    public AlipayTradeAppPayRequestBuilder setDisablePayChannels(String disablePayChannels) {
    ...
    public String getExtUserInfo() {
        return bizContent.extUserInfo;
    }

    public AlipayTradeAppPayRequestBuilder setExtUserInfo(String extUserInfo) {
        bizContent.extUserInfo = extUserInfo;
        return this;
    }
    ...
    public static class BizContent {
		...
		public String toString() {
            ...
            sb.append(", timeout_express='").append(timeoutExpress).append('\'');
            sb.append(", total_amount='").append(totalAmount).append('\'');
            sb.append(", product_code='").append(productCode).append('\'');
            sb.append(", goods_type='").append(goodsType).append('\'');
            sb.append(", passback_params=").append(passbackParams);
            sb.append(", promo_params=").append(promoParams);
            sb.append(", extend_params=").append(extendParams);
            sb.append(", passback_params=").append(passbackParams);
            sb.append(", enable_pay_channels='").append(enablePayChannels).append('\'');
            sb.append(", disable_pay_channels='").append(disablePayChannels).append('\'');
            sb.append(", store_id='").append(storeId).append('\'');
            sb.append(", ext_user_info=").append(extUserInfo);
            sb.append('}');
            return sb.toString();
        }
    }
