 ...
 */
public class AlipayTradeDownloadRequestBuilder extends AbsAlipayTradeRequestBuilder {
    ...
    @Override
	public AlipayTradeDownloadRequestBuilder setConfigs(Configuration configs) {
		return (AlipayTradeDownloadRequestBuilder) super.setConfigs(configs);
	}
