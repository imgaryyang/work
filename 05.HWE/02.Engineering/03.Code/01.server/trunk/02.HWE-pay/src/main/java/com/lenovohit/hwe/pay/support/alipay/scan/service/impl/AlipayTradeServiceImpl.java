...
import com.lenovohit.hwe.pay.support.alipay.scan.config.Constants;
...
public class AlipayTradeServiceImpl extends AbsAlipayTradeService {
    ...
    public static class ClientBuilder {
        ...
        public AlipayTradeServiceImpl build(Configuration config) {
            ...
            if (StringUtils.isEmpty(alipayPublicKey)) {
                alipayPublicKey = config.getString("alipay_public_key");//Configs.getAlipayPublicKey();
            }
