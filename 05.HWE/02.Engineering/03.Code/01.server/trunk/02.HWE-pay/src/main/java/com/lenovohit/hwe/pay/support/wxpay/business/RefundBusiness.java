...
public class RefundBusiness {
    ...
    public void run(RefundReqData refundReqData,ResultListener resultListener) throws Exception {
        ...
        refundResData.setResponseString(refundServiceResponseString);
        refundResData.setConfigs(refundReqData.getConfigs());
//
...
//        }
        ...
        if (refundResData.getReturn_code().equals("FAIL")) {
            ...
            //--------------------------------------------------------------------
            String key = refundReqData.getConfigs().getString("key");
            if (!Signature.checkIsSignValidFromResponseString(key, refundServiceResponseString)) {
