 ...
 */
public class AlipayTradePayRequestBuilder extends AbsAlipayTradeRequestBuilder {
    ...
    @Override
	public AlipayTradePayRequestBuilder setConfigs(Configuration configs) {
		return (AlipayTradePayRequestBuilder) super.setConfigs(configs);
	}
