package com.lenovohit.hwe.pay.support.wxpay.scan.protocol.pay_protocol;
...
public class ScanPayReqData extends BaseReqData {
     ...
     */
    public ScanPayReqData(String authCode,String body,String attach,String outTradeNo,int totalFee,String deviceInfo,String spBillCreateIP,String timeStart,String timeExpire,String goodsTag, Configuration configs){
