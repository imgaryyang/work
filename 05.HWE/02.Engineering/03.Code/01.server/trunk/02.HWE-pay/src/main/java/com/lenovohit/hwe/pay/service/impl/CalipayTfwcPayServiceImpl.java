...
public class CalipayTfwcPayServiceImpl implements PayBaseService {
	...
	public void prePay(Settlement settlement) {
        ...
        AlipayTradeCreateRequestBuilder builder = new AlipayTradeCreateRequestBuilder()
            ...
            .setBuyerId(settlement.getPayerNo()).setSellerId("").setBody(settlement.getSettleDesc())
        	...
        	.setConfigs(config);
        AlipayTradeCreateResult result = Alipay.tradeCreate(builder);
