 ...
 */
public class AlipayTradeRefundRequestBuilder extends AbsAlipayTradeRequestBuilder {
    ...
    @Override
	public AlipayTradeRefundRequestBuilder setConfigs(Configuration configs) {
		return (AlipayTradeRefundRequestBuilder) super.setConfigs(configs);
	}
    ...
    public AlipayTradeRefundRequestBuilder setOperatorId(String operatorId) {
