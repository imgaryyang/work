...
@Service("cwxpayTscanPayService")
public class CwxpayTscanPayServiceImpl implements PayBaseService {
    private static Log log = LogFactory.getLog(CwxpayTscanPayServiceImpl.class);
    private static String PAY_SUCCESS_RET = "<xml><return_code><![CDATA[SUCCESS]]></return_code><return_msg><![CDATA[OK]]></return_msg></xml>";
