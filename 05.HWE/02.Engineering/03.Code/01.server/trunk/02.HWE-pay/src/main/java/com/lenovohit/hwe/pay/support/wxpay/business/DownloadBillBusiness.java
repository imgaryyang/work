...
import com.lenovohit.hwe.pay.support.wxpay.protocol.downloadbill_protocol.DownloadBillResData;
...
public class DownloadBillBusiness {
    ...
    public void run(DownloadBillReqData downloadBillReqData,ResultListener resultListener) throws Exception {
        ...
        try {
            ...
            downloadBillResData.setConfigs(downloadBillReqData.getConfigs());
            ...
            ReportReqData reportReqData = new ReportReqData(
                    ...
                    "",
                    "",
                    downloadBillReqData.getConfigs().getString("ip"),//Configure.getIP()
                    downloadBillReqData.getConfigs()
            );

            long timeAfterReport;
            if(downloadBillReqData.getConfigs().getBoolean("useThreadToDoReport")){
