...
@Service("cunionpayCheckService")
public class CunionpayCheckServiceImpl implements CheckBaseService {
    private static Log                  log = LogFactory.getLog(CunionpayCheckServiceImpl.class);
