package com.lenovohit.hwe.pay.support.alipay.scan.config;
...
//
//    private static String localDomain;   	// 本地回调域名
//    private static String payCallbackUrl;	// 支付回调地址
//	public static String tradeOutTime;    // 交易过期时间
//
//
//    private Configs() {
//        // No Constructor
...
//        tradeOutTime = configs.getString("trade_out_time");
//
...
//		Configs.localDomain = localDomain;
//	}
//
...
//		Configs.payCallbackUrl = payCallbackUrl;
//	}
//
//	public static String getTradeOutTime() {
//		return tradeOutTime;
//	}
//
//	public static void setTradeOutTime(String tradeOutTime) {
//		Configs.tradeOutTime = tradeOutTime;
//	}
