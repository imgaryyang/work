package com.lenovohit.hwe.pay.support.wxpay.scan.common.report.protocol;
...
public class ReportReqData extends BaseReqData{
     ...
     */
    public ReportReqData(String deviceInfo, String interfaceUrl,int executeTimeCost, String returnCode,String returnMsg,String resultCode,String errCode,
    		String errCodeDes, String outTradeNo,String userIp, Configuration configs){
    	//设置配置
    	setConfigs(configs);
        ...
        setMch_id(this.getConfigs().getString("mchID"));//Configure.getMchid());
        setSub_mch_id(this.getConfigs().getString("subMchID"));//Configure.getSubMchid());
