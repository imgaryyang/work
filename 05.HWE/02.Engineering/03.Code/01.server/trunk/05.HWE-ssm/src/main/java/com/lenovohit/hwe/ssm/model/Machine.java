...
public class Machine extends AuditableModel{
	private static final long serialVersionUID = -600585186342353144L;

	private String code ;//编号
	private String name;//名称
	private String cashbox;//是否有钱箱  0：没有，1：有
...
//	private String regUser;//注册人
	...
	private String address;//自助机位置：由院区编号-楼编号-楼层组成
	
	private String monitorState;
	
//	private Set<MaterialDetailOut> details = new HashSet<MaterialDetailOut>();//材料一对多
//	private Set<TroubleDetail> troubleDetails = new HashSet<TroubleDetail>();//故障一对多
...
//	public Set<MaterialDetailOut> getDetails() {
//		return details;
//	}
//	public void setDetails(Set<MaterialDetailOut> details) {
//		this.details = details;
//	}
//	@OneToMany(targetEntity=TroubleDetail.class)
//	@JoinColumn(name="MACHINE_ID",referencedColumnName="ID")
//	public Set<TroubleDetail> getTroubleDetails() {
//		return troubleDetails;
//	}
//	public void setTroubleDetails(Set<TroubleDetail> troubleDetails) {
