package com.lenovohit.hwe.base.utils.jpush;
...
public class JpushClientUtil {
	...
	static {
		Properties p = null;
		try {
			p = PropertiesLoaderUtils.loadAllProperties("application-config-hwe-base.properties");
        ...
        return PushPayload.newBuilder()
                ...
                .setNotification(Notification.newBuilder()
                        ...
                        .addPlatformNotification(AndroidNotification.newBuilder()
                                .setAlert(notification_title+",查看详情>>")
...
//    }
	...
	public static void setAppKey(String appKey) {
		JpushClientUtil.appKey = appKey;
	}
    @Value("${jpush.mastersecret}")
	public static void setMasterSecret(String masterSecret) {
		JpushClientUtil.masterSecret = masterSecret;
	}
}
