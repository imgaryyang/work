              ...
              <View style={{ flexDirection: 'row' }} >
                <View style={{ flex: 1 }} >
                  <Form
                    ...
                    showLabel
                    onChange={(fieldName, fieldValue, formValue) => {
                      this.setState({ value2: formValue });
                    }}
                    value={this.state.value2}
                  >
                    <Form.TextInput name="temperature" label="体温:" dataType="number" placeholder="" buttonText={'\u2103'} />
                    <Form.TextInput name="heartRate" label="心率:" dataType="number" placeholder="" buttonText="次/分" />
                    <Form.TextInput name="pulse" label="脉搏:" dataType="number" placeholder="" buttonText="次" />
                    <Form.TextInput name="bloodPressureH" label="血压(高):" dataType="number" placeholder="" buttonText="mmHg" />
                    <Form.TextInput name="stool" label="大便:" dataType="number" placeholder="" buttonText="次" />
                  </Form>
                </View>
                <Sep width={5} />
                <View style={{ flex: 1 }} >
                  <Form
                    ...
                    showLabel
                    onChange={(fieldName, fieldValue, formValue) => {
                      this.setState({ value3: formValue });
                    }}
                    value={this.state.value3}
                  >
                    <Form.TextInput name="temperatureDown" label="降温后:" dataType="number" placeholder="" buttonText={'\u2103'} />
                    <Form.TextInput name="breathe" label="呼吸:" dataType="number" placeholder="" buttonText="次/分" />
                    <Form.TextInput name="painScore" label="疼痛评分:" dataType="number" placeholder="" />
                    <Form.TextInput name="bloodPressureL" label="血压(低):" dataType="number" placeholder="" buttonText="mmHg" />
                    <Form.TextInput name="urineVolume" label="尿量:" dataType="number" placeholder="" buttonText="ml" />
                  </Form>
                </View>
              </View>
              <Form
                ...
                showLabel
                onChange={(fieldName, fieldValue, formValue) => {
                  this.setState({ value4: formValue });
                }}
                value={this.state.value4}
              >
                <Form.TextInput name="infusion" label="输液量:" dataType="number" placeholder="" buttonText="次" />
                <Form.TextInput name="weight" label="体重:" dataType="number" placeholder="" buttonText="Kg" buttonStyle={{ textAlign: 'right' }} />
              </Form>
