...
class EditProfile extends Component {
  ...
  state = {
    doRenderScene: false,
    value: { ...this.props.auth.user, age: this.props.auth.user.age.toString() },
        ...
        <ScrollView style={styles.scrollView} keyboardShouldPersistTaps="always" >
          ...
          >
            <Form.TextInput
              name="name"
              label="昵称"
              placeholder={this.props.auth.user.name == null ? '昵称将用于显示' : this.props.auth.user.name}
              clearTextOnFocus
            />
            <Form.Checkbox
              style={null}
          ...
          <View style={styles.buttonHolder} >
            <Button text="清空" onPress={() => this.setState({ value: null })} theme={Button.THEME.BLUE} />
            <Sep width={10} />
