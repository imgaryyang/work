...
class EasyTextInputField extends Component {
  ...
  /**
	...
	_getTextInput(_fontSize, _color, _fontWeight, _lineHeight, _textAlign) {
	  ...
	  const { config, name, value, dataType, label, help, error,
      ...
      <TextInput
        ...
        style={[styles.textInput, _fontSize, _color, _fontWeight, _lineHeight, _textAlign, { height: this._textInputConfig.style.height }]}
