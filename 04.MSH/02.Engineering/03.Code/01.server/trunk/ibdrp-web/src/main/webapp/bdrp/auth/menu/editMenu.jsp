...
<div class="box-container" style="display:inline-block;">
	<form method='post' id='menuForm' name='menuForm' action='' >
		<!-- 隐藏功能的ID -->
		<input type="hidden" id="meId" name="model.id" value="${list.id }">
		<!-- 用户判断编码是否改变 -->
		<input type="hidden" id="meCode" name="meCode" value="${list.code }">
		<!-- 隐藏标签，功能的父节点ID -->
		<!-- 用于传递功能的父节点ID -->
		<!-- <input type="hidden" id="menuParent" name="model.parent.id"> -->
		<input type="hidden" id="parentid" value="${list.parent.id }">
		...
		<div class="f-div-row">
			...
			<div class="f-div-input-c4">
				<input id="code" type="text" class=c-ff-input name="model.code" value="${list.code }" _nullable=false _nullablemsg=请填写编码  _maxlength=50 _maxlengthmsg='最大长度为50'>	<br/>
		...
		<div  class="f-div-row">
			...
			<div class="f-div-input-c4">
				<input id="name" type="text" class=c-ff-input name="model.name" value="${list.name }" _nullable=false _nullablemsg=请填写名称  _maxlength=50 _maxlengthmsg='最大长度为50'>
			...
			<div class="f-div-input-c4">
				 <input id="serviceId" type="hidden" class=c-ff-input name="model.service.id" value="${list.service.id }">
				 <input id="serviceName" type="text" class=c-ff-input readonly="readonly" name="model.service.name" value="${list.service.name }" _nullable=false _nullablemsg=请选择服务>
		...
		<div  class="f-div-row">
			...
			<div class="f-div-input-c4">
				<input id="iconPath" type="text" class=c-ff-input readonly="readonly" name="model.iconPath" value="${list.iconPath }">
			</div>
			<div class="f-div-label-c4"><label>显示位置:</label></div>
			<div class="f-div-input-c4">
				<c:if test="${list.accType == '1' }">
				...
				<c:if test="${list.accType == '2' }">
					<input id="accType" type="radio" name="model.accType" value="1">&nbsp;&nbsp;导航菜单
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<input id="accType" type="radio" name="model.accType" value="2" checked="checked">&nbsp;&nbsp;管理中心
				</c:if>
			</div>
		</div>
		<div  class="f-div-row">
			...
			<div class="f-div-input-c4">
				<textarea id="descp" name="model.descp" rows="3" cols="20">${list.descp }</textarea>
			</div>
		</div>
