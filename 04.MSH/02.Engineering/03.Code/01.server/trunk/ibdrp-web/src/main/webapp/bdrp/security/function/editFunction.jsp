				...
				<table  width=100% border=0 cellspacing=0 cellpadding=0>
					...
					<tr class=f-tab-row>
						...
						<td class=f-tab-col-input-nowidth width="20%">
							<input id="functionName" type="text" class=c-ff-input name="functionName">
					...
					<tr class=f-tab-row>
						...
						<td class=f-tab-col-input-nowidth width="20%">
							<input id="resCode" type="text" class=c-ff-input name="model.code"  _nullable=false _nullablemsg=请填写名称  _maxlength=50 _maxlengthmsg='最大长度为50'>
