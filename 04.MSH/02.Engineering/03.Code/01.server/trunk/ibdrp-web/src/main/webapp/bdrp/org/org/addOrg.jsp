			...
			<div id=cbBanks class=float-tp-holder>
				...
				<div id="tp1item" >
					<div class="f-div-row">
						...
						<div class="f-div-input-c4"><input id="shortName" type="text" class=c-ff-input _maxlength=20 _maxlengthmsg='最大长度为20' name="shortName"></div>
					</div>
					<div  class="f-div-row">
						<div class="f-div-label-c4"><label>名称<font color="red">&nbsp;*&nbsp;</font>:</label></div>
						<div class="f-div-input-c4">
							<input id="name"" type="text" class=c-ff-input name="name" _nullable=false _nullablemsg=请填写名称>	
						...
						<div class="f-div-input-c4">
							<input id="status" type="text" class=c-ff-input _maxlength=1 _maxlengthmsg='最大长度为1' name="status">
							<p id="status1" style="display : none;"><font color="red">* 客户状态长度为1</font></p>
						</div>
					</div>
					<div  class="f-div-row">
						<div class="f-div-label-c4"><label>行业分类</label></div>
						<div class="f-div-input-c4"><input id="categry" type="text" class=c-ff-input _maxlength=50 _maxlengthmsg='最大长度为50' name="categry"></div>
						<div class="f-div-label-c4"><label>营业执照:</label></div>
						<div class="f-div-input-c4"><input id="licnum" type="text" class=c-ff-input _maxlength=50 _maxlengthmsg='最大长度为50' name="licnum"></div>
					</div>
					<div  class="f-div-row">
						<div class="f-div-label-c4"><label>英文名:</label></div>
						<div class="f-div-input-c4"><input id="enName" type="text" class=c-ff-input _maxlength=50 _maxlengthmsg='最大长度为50' name="enName"></div>
						<div class="f-div-label-c4"><label>机构性质:</label></div>
						<div class="f-div-input-c4"><input id="type" type="text" class=c-ff-input _maxlength=50 _maxlengthmsg='最大长度为50' name="type"></div>
					</div>
					<div  class="f-div-row">
						<div class="f-div-label-c4"></div>
						<div class="f-div-input-c4"></div>
						<div class="f-div-label-c4"><label>机构地址:</label></div>
						<div class="f-div-input-c4"><input id="visaAddress" type="text" class=c-ff-input _maxlength=100 _maxlengthmsg='最大长度为100' name="visaAddress"></div>
					</div>
				</div>
				</div>
			</div>
				...
				<div id="tp1item" >
					...
					<div  class=f-div-row>
						...
						<div class=f-div-input-c4>
							...
							<!-- 
							<input id="idType" type="text" class=c-ff-input name="idType">
							 -->
						</div>
						<div class="f-div-label-c4"><label>证件号码:</label></div>
						<div class="f-div-input-c4">
							<input id="idNo" type="text" class=c-ff-input _maxlength=18 _maxlengthmsg='最大长度为18' name="idNo">
							<p id="idNo1" style="display : none;"><font color="red">* 证件号码长度为18</font></p>
						</div>
					</div>
					<div  class="f-div-row">
						<div class="f-div-label-c4"></div>
						...
						<div class="f-div-input-c4">
							<textarea id="memo" name="memo" _maxlength=500 _maxlengthmsg='最大长度为500' rows="3" cols="10"></textarea>
						</div>
					</div>
				</div>
				</div>
